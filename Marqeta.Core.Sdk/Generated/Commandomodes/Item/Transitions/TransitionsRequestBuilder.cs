...
namespace Marqeta.Core.Sdk.Commandomodes.Item.Transitions
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Commandomodes.Item.Transitions.TransitionsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.CommandoModeTransitionListResponse?> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Commandomodes.Item.Transitions.TransitionsRequestBuilder.TransitionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.CommandoModeTransitionListResponse> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Commandomodes.Item.Transitions.TransitionsRequestBuilder.TransitionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Commandomodes.Item.Transitions.TransitionsRequestBuilder.TransitionsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Commandomodes.Item.Transitions.TransitionsRequestBuilder.TransitionsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Commandomodes.Item.Transitions.TransitionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Commandomodes.Item.Transitions.TransitionsRequestBuilder WithUrl(string rawUrl)
        {
