...
namespace Marqeta.Core.Sdk.Commandomodes.Item
{
    ...
    public partial class Commandomode_tokenItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The transitions property</summary>
        public global::Marqeta.Core.Sdk.Commandomodes.Item.Transitions.TransitionsRequestBuilder Transitions
        {
            get => new global::Marqeta.Core.Sdk.Commandomodes.Item.Transitions.TransitionsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Commandomodes.Item.Commandomode_tokenItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.Commando_mode_response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.Commando_mode_response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Commandomodes.Item.Commandomode_tokenItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Commandomodes.Item.Commandomode_tokenItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
