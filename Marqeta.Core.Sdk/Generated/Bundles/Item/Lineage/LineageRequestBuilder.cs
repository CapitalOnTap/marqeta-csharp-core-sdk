...
namespace Marqeta.Core.Sdk.Bundles.Item.Lineage
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Bundles.Item.Lineage.LineageRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.BundleResponsePage?> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Bundles.Item.Lineage.LineageRequestBuilder.LineageRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.BundleResponsePage> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Bundles.Item.Lineage.LineageRequestBuilder.LineageRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Bundles.Item.Lineage.LineageRequestBuilder.LineageRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Bundles.Item.Lineage.LineageRequestBuilder.LineageRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Bundles.Item.Lineage.LineageRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Bundles.Item.Lineage.LineageRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Bundles.Item.Lineage.LineageRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve an array of related product bundles.This endpoint supports &lt;&lt;/core-api/sorting-and-pagination, sorting and pagination&gt;&gt;.
        /// </summary>
        public class LineageRequestBuilderGetQueryParameters 
        {
            ...
            public Marqeta.Core.Sdk.Bundles.Item.Lineage.GetSort_byQueryParameterType? SortBy { get; set; }
