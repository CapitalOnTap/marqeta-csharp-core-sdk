    ...
    public partial class AcceptedcountriesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Marqeta.Core.Sdk.Acceptedcountries.Item.WithTokenItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Marqeta.Core.Sdk.Acceptedcountries.Item.WithTokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Acceptedcountries.AcceptedcountriesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.AcceptedCountriesListResponse?> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Acceptedcountries.AcceptedcountriesRequestBuilder.AcceptedcountriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.AcceptedCountriesListResponse> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Acceptedcountries.AcceptedcountriesRequestBuilder.AcceptedcountriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Acceptedcountries.AcceptedcountriesRequestBuilder.AcceptedcountriesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Acceptedcountries.AcceptedcountriesRequestBuilder.AcceptedcountriesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Acceptedcountries.AcceptedcountriesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Acceptedcountries.AcceptedcountriesRequestBuilder WithUrl(string rawUrl)
        {
