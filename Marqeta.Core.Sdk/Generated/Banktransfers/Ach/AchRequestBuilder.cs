...
namespace Marqeta.Core.Sdk.Banktransfers.Ach
{
    ...
    public class AchRequestBuilder : BaseRequestBuilder
    {
        ...
        public Marqeta.Core.Sdk.Banktransfers.Ach.Earlyfunds.EarlyfundsRequestBuilder Earlyfunds
        {
            get => new Marqeta.Core.Sdk.Banktransfers.Ach.Earlyfunds.EarlyfundsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The transitions property</summary>
        public Marqeta.Core.Sdk.Banktransfers.Ach.Transitions.TransitionsRequestBuilder Transitions
        {
            get => new Marqeta.Core.Sdk.Banktransfers.Ach.Transitions.TransitionsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Marqeta.Core.Sdk.Banktransfers.Ach.Item.WithTokenItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("token", position);
                return new Marqeta.Core.Sdk.Banktransfers.Ach.Item.WithTokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Banktransfers.Ach.AchRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.BankTransferListResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="Marqeta.Core.Sdk.Models.ApiError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.BankTransferListResponse?> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Banktransfers.Ach.AchRequestBuilder.AchRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.BankTransferListResponse> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Banktransfers.Ach.AchRequestBuilder.AchRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Marqeta.Core.Sdk.Models.BankTransferListResponse>(requestInfo, Marqeta.Core.Sdk.Models.BankTransferListResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.Bank_transfer_response_model?> PostAsync(Marqeta.Core.Sdk.Models.Bank_transfer_request_model body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.Bank_transfer_response_model> PostAsync(Marqeta.Core.Sdk.Models.Bank_transfer_request_model body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Banktransfers.Ach.AchRequestBuilder.AchRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Banktransfers.Ach.AchRequestBuilder.AchRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Marqeta.Core.Sdk.Models.Bank_transfer_request_model body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Marqeta.Core.Sdk.Models.Bank_transfer_request_model body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Banktransfers.Ach.AchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Banktransfers.Ach.AchRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Banktransfers.Ach.AchRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve a list of all ACH transfers.
        /// </summary>
