...
namespace Marqeta.Core.Sdk.Cardtransitions
{
    ...
    public partial class CardtransitionsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The card property</summary>
        public global::Marqeta.Core.Sdk.Cardtransitions.Card.CardRequestBuilder Card
        {
        ...
        public global::Marqeta.Core.Sdk.Cardtransitions.Item.WithTokenItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Marqeta.Core.Sdk.Cardtransitions.Item.WithTokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Cardtransitions.CardtransitionsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.Card_transition_response?> PostAsync(global::Marqeta.Core.Sdk.Models.Card_transition_request body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.Card_transition_response> PostAsync(global::Marqeta.Core.Sdk.Models.Card_transition_request body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Marqeta.Core.Sdk.Models.Card_transition_request body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Marqeta.Core.Sdk.Models.Card_transition_request body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Cardtransitions.CardtransitionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Cardtransitions.CardtransitionsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Cardtransitions.CardtransitionsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
