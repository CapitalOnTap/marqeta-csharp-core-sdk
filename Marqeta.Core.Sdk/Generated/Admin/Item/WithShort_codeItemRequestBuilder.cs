...
namespace Marqeta.Core.Sdk.Admin.Item {
    ...
    public class WithShort_codeItemRequestBuilder : BaseRequestBuilder {
        ...
        public ReplayfailedstatementRequestBuilder Replayfailedstatement { get =>
            new ReplayfailedstatementRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The retryachpayments property</summary>
        public RetryachpaymentsRequestBuilder Retryachpayments { get =>
            new RetryachpaymentsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
