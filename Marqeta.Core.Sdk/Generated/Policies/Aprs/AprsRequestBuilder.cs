...
namespace Marqeta.Core.Sdk.Policies.Aprs
{
    ...
    public class AprsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <returns>A <see cref="Marqeta.Core.Sdk.Policies.Aprs.Item.WithTokenItemRequestBuilder"/></returns>
        public Marqeta.Core.Sdk.Policies.Aprs.Item.WithTokenItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("token", position);
                return new Marqeta.Core.Sdk.Policies.Aprs.Item.WithTokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Policies.Aprs.AprsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.PolicyAprsPage?> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Policies.Aprs.AprsRequestBuilder.AprsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.PolicyAprsPage> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Policies.Aprs.AprsRequestBuilder.AprsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.PolicyAprResponse?> PostAsync(Marqeta.Core.Sdk.Models.PolicyAprCreateReq body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.PolicyAprResponse> PostAsync(Marqeta.Core.Sdk.Models.PolicyAprCreateReq body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Policies.Aprs.AprsRequestBuilder.AprsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Policies.Aprs.AprsRequestBuilder.AprsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Marqeta.Core.Sdk.Models.PolicyAprCreateReq body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Marqeta.Core.Sdk.Models.PolicyAprCreateReq body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Policies.Aprs.AprsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Policies.Aprs.AprsRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Policies.Aprs.AprsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve an array of existing APR policies.This endpoint supports &lt;&lt;/core-api/sorting-and-pagination, sorting and pagination&gt;&gt;.
        /// </summary>
        public class AprsRequestBuilderGetQueryParameters 
        {
            ...
            public Marqeta.Core.Sdk.Policies.Aprs.GetSort_byQueryParameterType? SortBy { get; set; }
