...
namespace Marqeta.Core.Sdk.Policies.Aprs.Item.Schedule
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Policies.Aprs.Item.Schedule.ScheduleRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.PolicyAprsPage?> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Policies.Aprs.Item.Schedule.ScheduleRequestBuilder.ScheduleRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.PolicyAprsPage> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Policies.Aprs.Item.Schedule.ScheduleRequestBuilder.ScheduleRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Policies.Aprs.Item.Schedule.ScheduleRequestBuilder.ScheduleRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Policies.Aprs.Item.Schedule.ScheduleRequestBuilder.ScheduleRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Policies.Aprs.Item.Schedule.ScheduleRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Policies.Aprs.Item.Schedule.ScheduleRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Policies.Aprs.Item.Schedule.ScheduleRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve an array of the historic annual percentage rate (APR) schedules on a specific APR policy.This endpoint supports &lt;&lt;/core-api/sorting-and-pagination, sorting and pagination&gt;&gt;.
        /// </summary>
        ...
        public partial class ScheduleRequestBuilderGetQueryParameters 
        {
            ...
            public global::Marqeta.Core.Sdk.Policies.Aprs.Item.Schedule.GetSort_byQueryParameterType? SortBy { get; set; }
