...
using System;
namespace Marqeta.Core.Sdk.Credit.Rewardprograms.Redemptions {
    /// <summary>
    /// Builds and executes requests for operations under \credit\rewardprograms\redemptions
    /// </summary>
    public class RedemptionsRequestBuilder : BaseRequestBuilder {
        ...
        public RedemptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/credit/rewardprograms/redemptions?settlement_end_date={settlement_end_date}&settlement_start_date={settlement_start_date}{&count*,destination*,start_index*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="RedemptionsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RedemptionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/credit/rewardprograms/redemptions?settlement_end_date={settlement_end_date}&settlement_start_date={settlement_start_date}{&count*,destination*,start_index*}", rawUrl) {
        }
        /// <summary>
