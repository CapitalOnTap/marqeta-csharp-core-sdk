...
using System;
namespace Marqeta.Core.Sdk.Credit.Rewardprograms.Item.Entries.Balance {
    /// <summary>
    /// Builds and executes requests for operations under \credit\rewardprograms\{token}\entries\balance
    /// </summary>
    public class BalanceRequestBuilder : BaseRequestBuilder {
        ...
        public BalanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/credit/rewardprograms/{token}/entries/balance?end_date={end_date}&start_date={start_date}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="BalanceRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BalanceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/credit/rewardprograms/{token}/entries/balance?end_date={end_date}&start_date={start_date}", rawUrl) {
        }
        /// <summary>
        /// Retrieve the balance of reward entries, which is the accrued rewards amount, within a specified date range.The reward accrual service calculates values to a 4 point precision, however the retrieve reward balance endpoint returns pending and accrued balances to a 2 point precision
        /// </summary>
