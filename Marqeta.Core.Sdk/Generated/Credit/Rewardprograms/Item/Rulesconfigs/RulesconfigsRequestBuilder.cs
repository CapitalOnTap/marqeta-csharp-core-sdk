// <auto-generated/>
using Marqeta.Core.Sdk.Credit.Rewardprograms.Item.Rulesconfigs.Applied;
...
namespace Marqeta.Core.Sdk.Credit.Rewardprograms.Item.Rulesconfigs {
    /// <summary>
    /// Builds and executes requests for operations under \credit\rewardprograms\{token}\rulesconfigs
    /// </summary>
    public class RulesconfigsRequestBuilder : BaseRequestBuilder {
        ...
        public RulesconfigsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/credit/rewardprograms/{token}/rulesconfigs{?count*,is_active*,sort_by*,start_index*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="RulesconfigsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RulesconfigsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/credit/rewardprograms/{token}/rulesconfigs{?count*,is_active*,sort_by*,start_index*}", rawUrl) {
        }
        /// <summary>
