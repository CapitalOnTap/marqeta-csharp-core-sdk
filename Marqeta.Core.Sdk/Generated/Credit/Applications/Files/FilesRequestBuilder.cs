...
namespace Marqeta.Core.Sdk.Credit.Applications.Files
{
    ...
    public partial class FilesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Marqeta.Core.Sdk.Credit.Applications.Files.Item.WithTypeItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("type", position);
                return new global::Marqeta.Core.Sdk.Credit.Applications.Files.Item.WithTypeItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Credit.Applications.Files.FilesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Models.FileMapResponse"/></returns>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.FileMapResponse?> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Credit.Applications.Files.FilesRequestBuilder.FilesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.FileMapResponse> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Credit.Applications.Files.FilesRequestBuilder.FilesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Marqeta.Core.Sdk.Models.FileMapResponse>(requestInfo, global::Marqeta.Core.Sdk.Models.FileMapResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieve an array of files on a bundle or applicationEach top-level object returned in the array contains the fields documented in the &lt;&lt;/core-api/credit-applications#_response_body_4, response body&gt;&gt;. The name of each object is its corresponding file type:* `BENEFITS_DISCLOSURE`* `CARD_MEMBER_AGREEMENT`* `E_DISCLOSURE`* `NOAA`* `PRIVACY_POLICY`* `REWARDS_DISCLOSURE_PRE_TERMS`* `REWARDS_DISCLOSURE_POST_TERMS`* `SOCT`* `TERMS_SCHEDULE`
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Credit.Applications.Files.FilesRequestBuilder.FilesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Credit.Applications.Files.FilesRequestBuilder.FilesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Credit.Applications.Files.FilesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Credit.Applications.Files.FilesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Credit.Applications.Files.FilesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve an array of files on a bundle or applicationEach top-level object returned in the array contains the fields documented in the &lt;&lt;/core-api/credit-applications#_response_body_4, response body&gt;&gt;. The name of each object is its corresponding file type:* `BENEFITS_DISCLOSURE`* `CARD_MEMBER_AGREEMENT`* `E_DISCLOSURE`* `NOAA`* `PRIVACY_POLICY`* `REWARDS_DISCLOSURE_PRE_TERMS`* `REWARDS_DISCLOSURE_POST_TERMS`* `SOCT`* `TERMS_SCHEDULE`
        /// </summary>
