...
namespace Marqeta.Core.Sdk.Credit.Applications.Item
{
    ...
    public class WithTokenItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Marqeta.Core.Sdk.Credit.Applications.Item.Transitions.TransitionsRequestBuilder Transitions
        {
            get => new Marqeta.Core.Sdk.Credit.Applications.Item.Transitions.TransitionsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Credit.Applications.Item.WithTokenItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.ApplicationsResponse?> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Credit.Applications.Item.WithTokenItemRequestBuilder.WithTokenItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.ApplicationsResponse> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Credit.Applications.Item.WithTokenItemRequestBuilder.WithTokenItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Credit.Applications.Item.WithTokenItemRequestBuilder.WithTokenItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Credit.Applications.Item.WithTokenItemRequestBuilder.WithTokenItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Credit.Applications.Item.WithTokenItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Credit.Applications.Item.WithTokenItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve a specific application.
        /// </summary>
...
#nullable enable
            ...
            public Marqeta.Core.Sdk.Models.ExpandObjects[]? Expand { get; set; }
#nullable restore
#else
            [QueryParameter("expand")]
            public Marqeta.Core.Sdk.Models.ExpandObjects[] Expand { get; set; }
