...
namespace Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Yeartodate
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Yeartodate.YeartodateRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Yeartodate.YeartodateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Yeartodate.YeartodateRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Yeartodate.YeartodateRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
