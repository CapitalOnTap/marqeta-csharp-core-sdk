...
namespace Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Journalentries
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Journalentries.JournalentriesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.JournalEntriesPage?> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Journalentries.JournalentriesRequestBuilder.JournalentriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.JournalEntriesPage> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Journalentries.JournalentriesRequestBuilder.JournalentriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Journalentries.JournalentriesRequestBuilder.JournalentriesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Journalentries.JournalentriesRequestBuilder.JournalentriesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Journalentries.JournalentriesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Journalentries.JournalentriesRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Journalentries.JournalentriesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve an array of journal entries on a credit account&apos;s statement summary.This endpoint supports &lt;&lt;/core-api/sorting-and-pagination, sorting&gt;&gt;.
        /// </summary>
...
#nullable enable
            ...
            public Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Journalentries.GetExpandQueryParameterType[]? Expand { get; set; }
#nullable restore
#else
            [QueryParameter("expand")]
            public Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Journalentries.GetExpandQueryParameterType[] Expand { get; set; }
            ...
            public Marqeta.Core.Sdk.Accounts.Item.Statements.Item.Journalentries.GetSort_byQueryParameterType? SortBy { get; set; }
