...
namespace Marqeta.Core.Sdk.Accounts.Item.Statements
{
    ...
    public class StatementsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Marqeta.Core.Sdk.Accounts.Item.Statements.Files.FilesRequestBuilder Files
        {
            get => new Marqeta.Core.Sdk.Accounts.Item.Statements.Files.FilesRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Marqeta.Core.Sdk.Accounts.Item.Statements.Item.WithStatement_summary_tokenItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("statement_summary_token", position);
                return new Marqeta.Core.Sdk.Accounts.Item.Statements.Item.WithStatement_summary_tokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Accounts.Item.Statements.StatementsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.StatementSummaryPage"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="Marqeta.Core.Sdk.Models.ApiError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.StatementSummaryPage?> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Accounts.Item.Statements.StatementsRequestBuilder.StatementsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.StatementSummaryPage> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Accounts.Item.Statements.StatementsRequestBuilder.StatementsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Marqeta.Core.Sdk.Models.StatementSummaryPage>(requestInfo, Marqeta.Core.Sdk.Models.StatementSummaryPage.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieve an array of statement summaries tied to a cardholder&apos;s account.The statement summary, which is a summary of account activity on a statement, provides account holders with a synopsis of activity that occurred on the account during a specified billing cycle.This endpoint supports &lt;&lt;/core-api/sorting-and-pagination, sorting and pagination&gt;&gt;.You can use optional query parameters to return a statement based on its exact opening or closing date, or a statement whose closing date falls within a range of dates.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Accounts.Item.Statements.StatementsRequestBuilder.StatementsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Accounts.Item.Statements.StatementsRequestBuilder.StatementsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Accounts.Item.Statements.StatementsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Accounts.Item.Statements.StatementsRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Accounts.Item.Statements.StatementsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve an array of statement summaries tied to a cardholder&apos;s account.The statement summary, which is a summary of account activity on a statement, provides account holders with a synopsis of activity that occurred on the account during a specified billing cycle.This endpoint supports &lt;&lt;/core-api/sorting-and-pagination, sorting and pagination&gt;&gt;.You can use optional query parameters to return a statement based on its exact opening or closing date, or a statement whose closing date falls within a range of dates.
        /// </summary>
        public class StatementsRequestBuilderGetQueryParameters 
        {
            ...
            public Marqeta.Core.Sdk.Accounts.Item.Statements.GetSort_byQueryParameterType? SortBy { get; set; }
