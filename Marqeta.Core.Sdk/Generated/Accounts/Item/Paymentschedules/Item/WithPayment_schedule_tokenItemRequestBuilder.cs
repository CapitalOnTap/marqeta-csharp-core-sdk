...
namespace Marqeta.Core.Sdk.Accounts.Item.Paymentschedules.Item {
    ...
    public class WithPayment_schedule_tokenItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="WithPayment_schedule_tokenItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<PaymentScheduleResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PaymentScheduleResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public WithPayment_schedule_tokenItemRequestBuilder WithUrl(string rawUrl)
        {
            return new WithPayment_schedule_tokenItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
