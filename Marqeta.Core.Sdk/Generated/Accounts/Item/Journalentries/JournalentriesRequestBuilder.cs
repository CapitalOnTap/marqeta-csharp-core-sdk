...
namespace Marqeta.Core.Sdk.Accounts.Item.Journalentries
{
    ...
    public partial class JournalentriesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.Item.WithJournal_entry_tokenItemRequestBuilder"/></returns>
        public global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.Item.WithJournal_entry_tokenItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("journal_entry_token", position);
                return new global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.Item.WithJournal_entry_tokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.JournalentriesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public JournalentriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_token}/journalentries{?card_tokens*,count*,detail_token*,end_created_time*,end_date*,end_impact_time*,expand*,groups*,sort_by*,start_created_time*,start_date*,start_impact_time*,start_index*,statuses*,types*,user_tokens*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.JournalentriesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public JournalentriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{account_token}/journalentries{?card_tokens*,count*,detail_token*,end_created_time*,end_date*,end_impact_time*,expand*,groups*,sort_by*,start_created_time*,start_date*,start_impact_time*,start_index*,statuses*,types*,user_tokens*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.JournalEntriesPage?> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.JournalentriesRequestBuilder.JournalentriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.JournalEntriesPage> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.JournalentriesRequestBuilder.JournalentriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.JournalentriesRequestBuilder.JournalentriesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.JournalentriesRequestBuilder.JournalentriesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.JournalentriesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.JournalentriesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.JournalentriesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve an array of journal entries on a credit account.This endpoint supports &lt;&lt;/core-api/sorting-and-pagination, sorting and pagination&gt;&gt; and &lt;&lt;/core-api/object-expansion, object expansion&gt;&gt;.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>Detail token of the journal entries to return.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable enable
            ...
            public global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.GetExpandQueryParameterType[]? Expand { get; set; }
#nullable restore
#else
            [QueryParameter("expand")]
            public global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.GetExpandQueryParameterType[] Expand { get; set; }
...
#nullable enable
            ...
            public global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.GetGroupsQueryParameterType[]? Groups { get; set; }
#nullable restore
#else
            [QueryParameter("groups")]
            public global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.GetGroupsQueryParameterType[] Groups { get; set; }
            ...
            public global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.GetSort_byQueryParameterType? SortBy { get; set; }
...
#nullable enable
            ...
            public global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.GetStatusesQueryParameterType[]? Statuses { get; set; }
#nullable restore
#else
            [QueryParameter("statuses")]
            public global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.GetStatusesQueryParameterType[] Statuses { get; set; }
...
#nullable enable
            ...
            public global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.GetTypesQueryParameterType[]? Types { get; set; }
#nullable restore
#else
            [QueryParameter("types")]
            public global::Marqeta.Core.Sdk.Accounts.Item.Journalentries.GetTypesQueryParameterType[] Types { get; set; }
