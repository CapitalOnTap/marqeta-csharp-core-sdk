...
namespace Marqeta.Core.Sdk.Accounts.Item.Disputes.Item
{
    ...
    public class WithDispute_tokenItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Marqeta.Core.Sdk.Accounts.Item.Disputes.Item.Transitions.TransitionsRequestBuilder Transitions
        {
            get => new Marqeta.Core.Sdk.Accounts.Item.Disputes.Item.Transitions.TransitionsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Accounts.Item.Disputes.Item.WithDispute_tokenItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.DisputeResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.DisputeResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Accounts.Item.Disputes.Item.WithDispute_tokenItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Accounts.Item.Disputes.Item.WithDispute_tokenItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
