...
namespace Marqeta.Core.Sdk.Accounts.Item {
    ...
    public class WithAccount_tokenItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        public AccounttransitionsRequestBuilder Accounttransitions
        {
            get => new AccounttransitionsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The adjustments property</summary>
        public AdjustmentsRequestBuilder Adjustments
        {
            get => new AdjustmentsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The billingcycle property</summary>
        public BillingcycleRequestBuilder Billingcycle
        {
            get => new BillingcycleRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public CreditbalancerefundsRequestBuilder Creditbalancerefunds
        {
            get => new CreditbalancerefundsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The delinquencystate property</summary>
        public DelinquencystateRequestBuilder Delinquencystate
        {
            get => new DelinquencystateRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The disputes property</summary>
        public DisputesRequestBuilder Disputes
        {
            get => new DisputesRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public PaymentschedulesRequestBuilder Paymentschedules
        {
            get => new PaymentschedulesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The periodicfeeschedules property</summary>
        public PeriodicfeeschedulesRequestBuilder Periodicfeeschedules
        {
            get => new PeriodicfeeschedulesRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public StatementsRequestBuilder Statements
        {
            get => new StatementsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
