...
namespace Marqeta.Core.Sdk.Fundingsources.Ach
{
    ...
    public partial class AchRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Marqeta.Core.Sdk.Fundingsources.Ach.Partner.PartnerRequestBuilder Partner
        {
        ...
        public global::Marqeta.Core.Sdk.Fundingsources.Ach.Item.WithFunding_source_tokenItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Marqeta.Core.Sdk.Fundingsources.Ach.Item.WithFunding_source_tokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Fundingsources.Ach.AchRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.Ach_response_model?> PostAsync(global::Marqeta.Core.Sdk.Models.Ach_model body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.Ach_response_model> PostAsync(global::Marqeta.Core.Sdk.Models.Ach_model body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Marqeta.Core.Sdk.Models.Ach_model body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Marqeta.Core.Sdk.Models.Ach_model body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Fundingsources.Ach.AchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Fundingsources.Ach.AchRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Fundingsources.Ach.AchRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
