...
namespace Marqeta.Core.Sdk.Fundingsources.Ach
{
    ...
    public class AchRequestBuilder : BaseRequestBuilder
    {
        ...
        public Marqeta.Core.Sdk.Fundingsources.Ach.Partner.PartnerRequestBuilder Partner
        {
            get => new Marqeta.Core.Sdk.Fundingsources.Ach.Partner.PartnerRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Marqeta.Core.Sdk.Fundingsources.Ach.Item.WithFunding_source_tokenItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("funding_source_token", position);
                return new Marqeta.Core.Sdk.Fundingsources.Ach.Item.WithFunding_source_tokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Fundingsources.Ach.AchRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.Ach_response_model?> PostAsync(Marqeta.Core.Sdk.Models.Ach_model body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.Ach_response_model> PostAsync(Marqeta.Core.Sdk.Models.Ach_model body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Marqeta.Core.Sdk.Models.Ach_model body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Marqeta.Core.Sdk.Models.Ach_model body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Fundingsources.Ach.AchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Fundingsources.Ach.AchRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Fundingsources.Ach.AchRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
