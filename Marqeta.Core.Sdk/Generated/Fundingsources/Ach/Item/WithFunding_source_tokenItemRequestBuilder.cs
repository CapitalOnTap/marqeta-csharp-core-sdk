...
namespace Marqeta.Core.Sdk.Fundingsources.Ach.Item
{
    ...
    public class WithFunding_source_tokenItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Marqeta.Core.Sdk.Fundingsources.Ach.Item.Verificationamounts.VerificationamountsRequestBuilder Verificationamounts
        {
            get => new Marqeta.Core.Sdk.Fundingsources.Ach.Item.Verificationamounts.VerificationamountsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Fundingsources.Ach.Item.WithFunding_source_tokenItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.Ach_response_model?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.Ach_response_model> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.Ach_response_model?> PutAsync(Marqeta.Core.Sdk.Models.Ach_verification_model body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.Ach_response_model> PutAsync(Marqeta.Core.Sdk.Models.Ach_verification_model body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(Marqeta.Core.Sdk.Models.Ach_verification_model body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(Marqeta.Core.Sdk.Models.Ach_verification_model body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Fundingsources.Ach.Item.WithFunding_source_tokenItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Fundingsources.Ach.Item.WithFunding_source_tokenItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Fundingsources.Ach.Item.WithFunding_source_tokenItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
