...
namespace Marqeta.Core.Sdk.Fundingsources.Ach.Item
{
    ...
    public partial class WithFunding_source_tokenItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Marqeta.Core.Sdk.Fundingsources.Ach.Item.Verificationamounts.VerificationamountsRequestBuilder Verificationamounts
        {
            get => new global::Marqeta.Core.Sdk.Fundingsources.Ach.Item.Verificationamounts.VerificationamountsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Fundingsources.Ach.Item.WithFunding_source_tokenItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.Ach_response_model?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.Ach_response_model> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Fundingsources.Ach.Item.WithFunding_source_tokenItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Fundingsources.Ach.Item.WithFunding_source_tokenItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
