...
namespace Marqeta.Core.Sdk.Fundingsources.Paymentcard
{
    ...
    public class PaymentcardRequestBuilder : BaseRequestBuilder
    {
        ...
        public Marqeta.Core.Sdk.Fundingsources.Paymentcard.Item.WithFunding_source_tokenItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("funding_source_token", position);
                return new Marqeta.Core.Sdk.Fundingsources.Paymentcard.Item.WithFunding_source_tokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Fundingsources.Paymentcard.PaymentcardRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.Payment_card_response_model?> PostAsync(Marqeta.Core.Sdk.Models.Token_request body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.Payment_card_response_model> PostAsync(Marqeta.Core.Sdk.Models.Token_request body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Marqeta.Core.Sdk.Models.Token_request body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Marqeta.Core.Sdk.Models.Token_request body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Fundingsources.Paymentcard.PaymentcardRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Fundingsources.Paymentcard.PaymentcardRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Fundingsources.Paymentcard.PaymentcardRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
