...
namespace Marqeta.Core.Sdk.Fundingsources.Business
{
    ...
    public partial class BusinessRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Marqeta.Core.Sdk.Fundingsources.Business.Item.WithBusiness_tokenItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("business_token", position);
                return new global::Marqeta.Core.Sdk.Fundingsources.Business.Item.WithBusiness_tokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Fundingsources.Business.BusinessRequestBuilder"/> and sets the default values.
        /// </summary>
