...
namespace Marqeta.Core.Sdk.Fundingsources.Program
{
    ...
    public partial class ProgramRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The ach property</summary>
        public global::Marqeta.Core.Sdk.Fundingsources.Program.Ach.AchRequestBuilder Ach
        {
        ...
        public global::Marqeta.Core.Sdk.Fundingsources.Program.Item.WithTokenItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Marqeta.Core.Sdk.Fundingsources.Program.Item.WithTokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Fundingsources.Program.ProgramRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.Program_funding_source_response?> PostAsync(global::Marqeta.Core.Sdk.Models.Program_funding_source_request body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.Program_funding_source_response> PostAsync(global::Marqeta.Core.Sdk.Models.Program_funding_source_request body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Marqeta.Core.Sdk.Models.Program_funding_source_request body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Marqeta.Core.Sdk.Models.Program_funding_source_request body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Fundingsources.Program.ProgramRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Fundingsources.Program.ProgramRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Fundingsources.Program.ProgramRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
