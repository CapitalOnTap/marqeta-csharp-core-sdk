...
namespace Marqeta.Core.Sdk.Autoreloads.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Autoreloads.Item.WithTokenItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.Auto_reload_response_model?> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Autoreloads.Item.WithTokenItemRequestBuilder.WithTokenItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.Auto_reload_response_model> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Autoreloads.Item.WithTokenItemRequestBuilder.WithTokenItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.Auto_reload_response_model?> PutAsync(global::Marqeta.Core.Sdk.Models.Auto_reload_update_model body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.Auto_reload_response_model> PutAsync(global::Marqeta.Core.Sdk.Models.Auto_reload_update_model body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Autoreloads.Item.WithTokenItemRequestBuilder.WithTokenItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Autoreloads.Item.WithTokenItemRequestBuilder.WithTokenItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::Marqeta.Core.Sdk.Models.Auto_reload_update_model body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::Marqeta.Core.Sdk.Models.Auto_reload_update_model body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Autoreloads.Item.WithTokenItemRequestBuilder WithUrl(string rawUrl)
        {
