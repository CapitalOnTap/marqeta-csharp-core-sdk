...
namespace Marqeta.Core.Sdk.Peertransfers
{
    ...
    public partial class PeertransfersRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The user property</summary>
        public global::Marqeta.Core.Sdk.Peertransfers.User.UserRequestBuilder User
        {
        ...
        public global::Marqeta.Core.Sdk.Peertransfers.Item.WithTokenItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Marqeta.Core.Sdk.Peertransfers.Item.WithTokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Peertransfers.PeertransfersRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.Peer_transfer_response?> PostAsync(global::Marqeta.Core.Sdk.Models.Peer_transfer_request body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.Peer_transfer_response> PostAsync(global::Marqeta.Core.Sdk.Models.Peer_transfer_request body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Marqeta.Core.Sdk.Models.Peer_transfer_request body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Marqeta.Core.Sdk.Models.Peer_transfer_request body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Peertransfers.PeertransfersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Peertransfers.PeertransfersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Peertransfers.PeertransfersRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
