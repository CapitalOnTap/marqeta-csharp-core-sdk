...
namespace Marqeta.Core.Sdk.Peertransfers.User.Item
{
    ...
    public class WithUser_or_business_tokenItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Marqeta.Core.Sdk.Peertransfers.User.Item.Recipient.RecipientRequestBuilder Recipient
        {
            get => new Marqeta.Core.Sdk.Peertransfers.User.Item.Recipient.RecipientRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The sender property</summary>
        public Marqeta.Core.Sdk.Peertransfers.User.Item.Sender.SenderRequestBuilder Sender
        {
            get => new Marqeta.Core.Sdk.Peertransfers.User.Item.Sender.SenderRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Peertransfers.User.Item.WithUser_or_business_tokenItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.Peer_transfer_response?> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Peertransfers.User.Item.WithUser_or_business_tokenItemRequestBuilder.WithUser_or_business_tokenItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.Peer_transfer_response> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Peertransfers.User.Item.WithUser_or_business_tokenItemRequestBuilder.WithUser_or_business_tokenItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Peertransfers.User.Item.WithUser_or_business_tokenItemRequestBuilder.WithUser_or_business_tokenItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Peertransfers.User.Item.WithUser_or_business_tokenItemRequestBuilder.WithUser_or_business_tokenItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Peertransfers.User.Item.WithUser_or_business_tokenItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Peertransfers.User.Item.WithUser_or_business_tokenItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Peertransfers.User.Item.WithUser_or_business_tokenItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Use this endpoint to list peer transfers sent or received by a particular account holder.Include a user or business token as a path parameter to identify the account holder whose transfers you want to list.This endpoint supports &lt;&lt;/core-api/field-filtering, field filtering&gt;&gt; and &lt;&lt;/core-api/sorting-and-pagination, pagination&gt;&gt;.
        /// </summary>
