...
namespace Marqeta.Core.Sdk.Products.Item.Lineage
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Products.Item.Lineage.LineageRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.ProductsPage?> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Products.Item.Lineage.LineageRequestBuilder.LineageRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.ProductsPage> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Products.Item.Lineage.LineageRequestBuilder.LineageRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Products.Item.Lineage.LineageRequestBuilder.LineageRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Products.Item.Lineage.LineageRequestBuilder.LineageRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Products.Item.Lineage.LineageRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Products.Item.Lineage.LineageRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Products.Item.Lineage.LineageRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve the lineage of a credit product, which is an array of related credit products whose lineage can be traced back to the same original credit product.This endpoint supports &lt;&lt;/core-api/sorting-and-pagination, sorting and pagination&gt;&gt;.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class LineageRequestBuilderGetQueryParameters 
        {
            ...
            public global::Marqeta.Core.Sdk.Products.Item.Lineage.GetSort_byQueryParameterType? SortBy { get; set; }
