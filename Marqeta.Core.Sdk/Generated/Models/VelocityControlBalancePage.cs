...
#nullable enable
        public List<VelocityControlBalance>? Data { get; set; }
#nullable restore
#else
        public List<VelocityControlBalance> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="VelocityControlBalancePage"/> and sets the default values.
        /// </summary>
        ...
        public static VelocityControlBalancePage CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new VelocityControlBalancePage();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<VelocityControlBalance>(VelocityControlBalance.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<VelocityControlBalance>("data", Data);
