...
#nullable enable
        public List<Card_transition_response>? Data { get; set; }
#nullable restore
#else
        public List<Card_transition_response> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="CardTransitionListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static CardTransitionListResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CardTransitionListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Card_transition_response>(Card_transition_response.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Card_transition_response>("data", Data);
