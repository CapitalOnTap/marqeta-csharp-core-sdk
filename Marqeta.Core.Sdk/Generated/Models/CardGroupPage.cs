...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class CardGroupPage : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Marqeta.Core.Sdk.Models.CardGroup>? Data { get; set; }
#nullable restore
#else
        public List<global::Marqeta.Core.Sdk.Models.CardGroup> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.CardGroupPage"/> and sets the default values.
        /// </summary>
        public CardGroupPage()
        {
        ...
        public static global::Marqeta.Core.Sdk.Models.CardGroupPage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.CardGroupPage();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "data", n => { Data = n.GetCollectionOfObjectValues<global::Marqeta.Core.Sdk.Models.CardGroup>(global::Marqeta.Core.Sdk.Models.CardGroup.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Marqeta.Core.Sdk.Models.CardGroup>("data", Data);
