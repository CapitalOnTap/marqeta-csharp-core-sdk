...
#nullable enable
        public List<CardGroup>? Data { get; set; }
#nullable restore
#else
        public List<CardGroup> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="CardGroupPage"/> and sets the default values.
        /// </summary>
        ...
        public static CardGroupPage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CardGroupPage();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<CardGroup>(CardGroup.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<CardGroup>("data", Data);
