...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class Original_credit_sender_data : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The deferred_hold_by property</summary>
        public global::Marqeta.Core.Sdk.Models.Original_credit_sender_data_deferred_hold_by? DeferredHoldBy { get; set; }
        ...
        public global::Marqeta.Core.Sdk.Models.Original_credit_sender_data_funding_source? FundingSource { get; set; }
...
#nullable restore
        ...
        public global::Marqeta.Core.Sdk.Models.Original_credit_sender_data_sender_account_type? SenderAccountType { get; set; }
...
#nullable restore
        ...
        public global::Marqeta.Core.Sdk.Models.Original_credit_sender_data_transaction_purpose? TransactionPurpose { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.Original_credit_sender_data"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Models.Original_credit_sender_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Marqeta.Core.Sdk.Models.Original_credit_sender_data CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.Original_credit_sender_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "deferred_hold_by", n => { DeferredHoldBy = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.Original_credit_sender_data_deferred_hold_by>(); } },
                { "fast_funds_enabled", n => { FastFundsEnabled = n.GetBoolValue(); } },
                { "funding_source", n => { FundingSource = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.Original_credit_sender_data_funding_source>(); } },
                { "sender_account_number", n => { SenderAccountNumber = n.GetStringValue(); } },
                { "sender_account_type", n => { SenderAccountType = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.Original_credit_sender_data_sender_account_type>(); } },
                ...
                { "transaction_purpose", n => { TransactionPurpose = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.Original_credit_sender_data_transaction_purpose>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.Original_credit_sender_data_deferred_hold_by>("deferred_hold_by", DeferredHoldBy);
            writer.WriteBoolValue("fast_funds_enabled", FastFundsEnabled);
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.Original_credit_sender_data_funding_source>("funding_source", FundingSource);
            writer.WriteStringValue("sender_account_number", SenderAccountNumber);
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.Original_credit_sender_data_sender_account_type>("sender_account_type", SenderAccountType);
            ...
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.Original_credit_sender_data_transaction_purpose>("transaction_purpose", TransactionPurpose);
