...
#nullable enable
        public List<Funding_account_response_model>? Data { get; set; }
#nullable restore
#else
        public List<Funding_account_response_model> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="FundingAccountListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static FundingAccountListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new FundingAccountListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Funding_account_response_model>(Funding_account_response_model.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Funding_account_response_model>("data", Data);
