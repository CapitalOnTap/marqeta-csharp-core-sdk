...
#nullable enable
        public List<Real_time_fee_group>? Data { get; set; }
#nullable restore
#else
        public List<Real_time_fee_group> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="RealTimeFeeGroupListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static RealTimeFeeGroupListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new RealTimeFeeGroupListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Real_time_fee_group>(Real_time_fee_group.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Real_time_fee_group>("data", Data);
