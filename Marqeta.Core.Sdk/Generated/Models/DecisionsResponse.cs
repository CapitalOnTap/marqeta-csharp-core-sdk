...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class DecisionsResponse : global::Marqeta.Core.Sdk.Models.PostDecisionsResponse, IParsable
    {
...
#nullable restore
        ...
        public global::Marqeta.Core.Sdk.Models.DecisionsResponse_card_product_level? CardProductLevel { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Marqeta.Core.Sdk.Models.CreditBureau? CreditBureau { get; set; }
#nullable restore
#else
        public global::Marqeta.Core.Sdk.Models.CreditBureau CreditBureau { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Models.DecisionsResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Marqeta.Core.Sdk.Models.DecisionsResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.DecisionsResponse();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "card_product_level", n => { CardProductLevel = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.DecisionsResponse_card_product_level>(); } },
                { "created_date", n => { CreatedDate = n.GetDateTimeOffsetValue(); } },
                { "credit_bureau", n => { CreditBureau = n.GetObjectValue<global::Marqeta.Core.Sdk.Models.CreditBureau>(global::Marqeta.Core.Sdk.Models.CreditBureau.CreateFromDiscriminatorValue); } },
                ...
                { "denial_reasons", n => { DenialReasons = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                ...
                { "score_factors", n => { ScoreFactors = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.DecisionsResponse_card_product_level>("card_product_level", CardProductLevel);
            writer.WriteDateTimeOffsetValue("created_date", CreatedDate);
            writer.WriteObjectValue<global::Marqeta.Core.Sdk.Models.CreditBureau>("credit_bureau", CreditBureau);
