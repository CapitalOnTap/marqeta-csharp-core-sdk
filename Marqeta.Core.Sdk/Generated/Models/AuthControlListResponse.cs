...
#nullable enable
        public List<Auth_control_response>? Data { get; set; }
#nullable restore
#else
        public List<Auth_control_response> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="AuthControlListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static AuthControlListResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new AuthControlListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Auth_control_response>(Auth_control_response.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Auth_control_response>("data", Data);
