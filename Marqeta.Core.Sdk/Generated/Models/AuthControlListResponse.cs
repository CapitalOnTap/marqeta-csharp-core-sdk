...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class AuthControlListResponse : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Marqeta.Core.Sdk.Models.Auth_control_response>? Data { get; set; }
#nullable restore
#else
        public List<global::Marqeta.Core.Sdk.Models.Auth_control_response> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.AuthControlListResponse"/> and sets the default values.
        /// </summary>
        public AuthControlListResponse()
        {
        ...
        public static global::Marqeta.Core.Sdk.Models.AuthControlListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.AuthControlListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "data", n => { Data = n.GetCollectionOfObjectValues<global::Marqeta.Core.Sdk.Models.Auth_control_response>(global::Marqeta.Core.Sdk.Models.Auth_control_response.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Marqeta.Core.Sdk.Models.Auth_control_response>("data", Data);
