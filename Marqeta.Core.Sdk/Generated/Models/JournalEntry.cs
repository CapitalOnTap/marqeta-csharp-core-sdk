...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.JournalEntry_detail_object? DetailObject { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.JournalEntry_detail_object DetailObject { get; set; }
#endif
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.JournalEntry_group? Group { get; set; }
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.JournalEntry_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.JournalEntry"/> and sets the default values.
        /// </summary>
        public JournalEntry()
        {
        ...
        public static Marqeta.Core.Sdk.Models.JournalEntry CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.JournalEntry();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "detail_object", n => { DetailObject = n.GetObjectValue<Marqeta.Core.Sdk.Models.JournalEntry_detail_object>(Marqeta.Core.Sdk.Models.JournalEntry_detail_object.CreateFromDiscriminatorValue); } },
                { "detail_token", n => { DetailToken = n.GetStringValue(); } },
                { "dispute_token", n => { DisputeToken = n.GetStringValue(); } },
                { "group", n => { Group = n.GetEnumValue<Marqeta.Core.Sdk.Models.JournalEntry_group>(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<Marqeta.Core.Sdk.Models.JournalEntry_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.JournalEntry_detail_object>("detail_object", DetailObject);
            writer.WriteStringValue("detail_token", DetailToken);
            writer.WriteStringValue("dispute_token", DisputeToken);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.JournalEntry_group>("group", Group);
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.JournalEntry_status>("status", Status);
