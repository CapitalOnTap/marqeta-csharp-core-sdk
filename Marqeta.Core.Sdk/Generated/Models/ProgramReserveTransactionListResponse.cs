...
#nullable enable
        public List<Program_reserve_transaction_response>? Data { get; set; }
#nullable restore
#else
        public List<Program_reserve_transaction_response> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="ProgramReserveTransactionListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static ProgramReserveTransactionListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ProgramReserveTransactionListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Program_reserve_transaction_response>(Program_reserve_transaction_response.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Program_reserve_transaction_response>("data", Data);
