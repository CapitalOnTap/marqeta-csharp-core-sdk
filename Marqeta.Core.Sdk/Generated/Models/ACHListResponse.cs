...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public class ACHListResponse : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// <summary>Array of ACH funding source objects.Objects are returned as appropriate to your query.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Marqeta.Core.Sdk.Models.Base_ach_response_model>? Data { get; set; }
#nullable restore
#else
        public List<Marqeta.Core.Sdk.Models.Base_ach_response_model> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.ACHListResponse"/> and sets the default values.
        /// </summary>
        public ACHListResponse()
        {
        ...
        public static Marqeta.Core.Sdk.Models.ACHListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.ACHListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "data", n => { Data = n.GetCollectionOfObjectValues<Marqeta.Core.Sdk.Models.Base_ach_response_model>(Marqeta.Core.Sdk.Models.Base_ach_response_model.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Marqeta.Core.Sdk.Models.Base_ach_response_model>("data", Data);
