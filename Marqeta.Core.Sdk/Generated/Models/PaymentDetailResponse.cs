...
#nullable restore
        ...
        /// <summary>List of objects that contain information about how a payment is allocated.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string PaymentSourceToken { get; set; }
#endif
        /// <summary>Date and time when the statement summary was migrated to Marqeta&apos;s credit platform, in UTC.The value of this field is `null` if it has not been migrated.</summary>
        public DateTimeOffset? ProgramMigrationTime { get; set; }
...
#nullable restore
        ...
        public string Token { get; set; }
#endif
        /// <summary>Contains one or more `transitions` objects, which contain information about a payment status transition.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>A value of `true` indicates that a returned payment fee should not be applied.The default value of this field is `false`.This field is only considered when transitioning the status of the fee to `REFUNDED`.</summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "program_migration_time", n => { ProgramMigrationTime = n.GetDateTimeOffsetValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteDateTimeOffsetValue("program_migration_time", ProgramMigrationTime);
