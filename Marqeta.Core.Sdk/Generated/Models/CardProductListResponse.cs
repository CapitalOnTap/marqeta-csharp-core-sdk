...
#nullable enable
        public List<Card_product_response>? Data { get; set; }
#nullable restore
#else
        public List<Card_product_response> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="CardProductListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static CardProductListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CardProductListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Card_product_response>(Card_product_response.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Card_product_response>("data", Data);
