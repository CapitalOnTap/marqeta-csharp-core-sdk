...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class CardProductListResponse : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// <summary>Array of card product objects.Objects are returned as appropriate to your query.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Marqeta.Core.Sdk.Models.Card_product_response>? Data { get; set; }
#nullable restore
#else
        public List<global::Marqeta.Core.Sdk.Models.Card_product_response> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.CardProductListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::Marqeta.Core.Sdk.Models.CardProductListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.CardProductListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "data", n => { Data = n.GetCollectionOfObjectValues<global::Marqeta.Core.Sdk.Models.Card_product_response>(global::Marqeta.Core.Sdk.Models.Card_product_response.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Marqeta.Core.Sdk.Models.Card_product_response>("data", Data);
