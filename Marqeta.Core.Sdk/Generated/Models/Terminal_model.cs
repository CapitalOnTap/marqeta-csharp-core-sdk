...
#nullable restore
        ...
        public global::Marqeta.Core.Sdk.Models.Terminal_model_special_condition_indicator? SpecialConditionIndicator { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.Terminal_model"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Models.Terminal_model"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Marqeta.Core.Sdk.Models.Terminal_model CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.Terminal_model();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "special_condition_indicator", n => { SpecialConditionIndicator = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.Terminal_model_special_condition_indicator>(); } },
                { "tid", n => { Tid = n.GetStringValue(); } },
                { "transaction_initiated_by", n => { TransactionInitiatedBy = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.Terminal_model_transaction_initiated_by>(); } },
                { "transaction_initiated_category", n => { TransactionInitiatedCategory = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.Terminal_model_transaction_initiated_category>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.Terminal_model_special_condition_indicator>("special_condition_indicator", SpecialConditionIndicator);
            writer.WriteStringValue("tid", Tid);
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.Terminal_model_transaction_initiated_by>("transaction_initiated_by", TransactionInitiatedBy);
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.Terminal_model_transaction_initiated_category>("transaction_initiated_category", TransactionInitiatedCategory);
