...
namespace Marqeta.Core.Sdk.Models {
    ...
    public class SubstatusUpdateReq_deactivation : IAdditionalDataHolder, IParsable 
    {
        ...
        public SubstatusUpdateReq_deactivation_channel? Channel { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="SubstatusUpdateReq_deactivation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="SubstatusUpdateReq_deactivation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static SubstatusUpdateReq_deactivation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SubstatusUpdateReq_deactivation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"channel", n => { Channel = n.GetEnumValue<SubstatusUpdateReq_deactivation_channel>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<SubstatusUpdateReq_deactivation_channel>("channel", Channel);
