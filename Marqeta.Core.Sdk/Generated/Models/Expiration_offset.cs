...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public class Expiration_offset : IAdditionalDataHolder, IParsable
    {
        ...
        public Marqeta.Core.Sdk.Models.Expiration_offset_unit? Unit { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.Expiration_offset"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.Expiration_offset"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Marqeta.Core.Sdk.Models.Expiration_offset CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.Expiration_offset();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "unit", n => { Unit = n.GetEnumValue<Marqeta.Core.Sdk.Models.Expiration_offset_unit>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Expiration_offset_unit>("unit", Unit);
