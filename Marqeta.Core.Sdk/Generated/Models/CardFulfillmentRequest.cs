...
namespace Marqeta.Core.Sdk.Models
{
    ...
    /// </summary>
    public class CardFulfillmentRequest : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Reason for card fulfillment.</summary>
        public Marqeta.Core.Sdk.Models.CardFulfillmentRequest_card_fulfillment_reason? CardFulfillmentReason { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.CardFulfillmentRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.CardFulfillmentRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Marqeta.Core.Sdk.Models.CardFulfillmentRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.CardFulfillmentRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "card_fulfillment_reason", n => { CardFulfillmentReason = n.GetEnumValue<Marqeta.Core.Sdk.Models.CardFulfillmentRequest_card_fulfillment_reason>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.CardFulfillmentRequest_card_fulfillment_reason>("card_fulfillment_reason", CardFulfillmentReason);
