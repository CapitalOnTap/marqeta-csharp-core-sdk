...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class Program_reserve_transaction_response : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::Marqeta.Core.Sdk.Models.Program_reserve_transaction_response_state? State { get; set; }
...
#nullable restore
        ...
        public global::Marqeta.Core.Sdk.Models.Program_reserve_transaction_response_type? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.Program_reserve_transaction_response"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Models.Program_reserve_transaction_response"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Marqeta.Core.Sdk.Models.Program_reserve_transaction_response CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.Program_reserve_transaction_response();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "state", n => { State = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.Program_reserve_transaction_response_state>(); } },
                { "tags", n => { Tags = n.GetStringValue(); } },
                { "token", n => { Token = n.GetStringValue(); } },
                { "transaction_token", n => { TransactionToken = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.Program_reserve_transaction_response_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.Program_reserve_transaction_response_state>("state", State);
            writer.WriteStringValue("tags", Tags);
            writer.WriteStringValue("token", Token);
            writer.WriteStringValue("transaction_token", TransactionToken);
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.Program_reserve_transaction_response_type>("type", Type);
