...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public DecisionsResponse? DecisionModel { get; set; }
#nullable restore
#else
        public DecisionsResponse DecisionModel { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApplicationsResponse_meta_data? MetaData { get; set; }
#nullable restore
#else
        public ApplicationsResponse_meta_data MetaData { get; set; }
#endif
...
#nullable restore
        ...
        public ApplicationsResponse_primary_income_source? PrimaryIncomeSource { get; set; }
        ...
        public ApplicationsResponse_residence_type? ResidenceType { get; set; }
        ...
        public ApplicationResourceState? State { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApplicationsResponse"/> and sets the default values.
        /// </summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"decision_model", n => { DecisionModel = n.GetObjectValue<DecisionsResponse>(DecisionsResponse.CreateFromDiscriminatorValue); } },
                ...
                {"error_details", n => { ErrorDetails = n.GetObjectValue<ErrorDetailsResponse>(ErrorDetailsResponse.CreateFromDiscriminatorValue); } },
                {"meta_data", n => { MetaData = n.GetObjectValue<ApplicationsResponse_meta_data>(ApplicationsResponse_meta_data.CreateFromDiscriminatorValue); } },
                ...
                {"primary_income_source", n => { PrimaryIncomeSource = n.GetEnumValue<ApplicationsResponse_primary_income_source>(); } },
                {"privacy_policy_accepted_at", n => { PrivacyPolicyAcceptedAt = n.GetDateTimeOffsetValue(); } },
                {"residence_type", n => { ResidenceType = n.GetEnumValue<ApplicationsResponse_residence_type>(); } },
                ...
                {"state", n => { State = n.GetEnumValue<ApplicationResourceState>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<DecisionsResponse>("decision_model", DecisionModel);
            ...
            writer.WriteObjectValue<ErrorDetailsResponse>("error_details", ErrorDetails);
            writer.WriteObjectValue<ApplicationsResponse_meta_data>("meta_data", MetaData);
            ...
            writer.WriteEnumValue<ApplicationsResponse_primary_income_source>("primary_income_source", PrimaryIncomeSource);
            writer.WriteDateTimeOffsetValue("privacy_policy_accepted_at", PrivacyPolicyAcceptedAt);
            writer.WriteEnumValue<ApplicationsResponse_residence_type>("residence_type", ResidenceType);
            ...
            writer.WriteEnumValue<ApplicationResourceState>("state", State);
