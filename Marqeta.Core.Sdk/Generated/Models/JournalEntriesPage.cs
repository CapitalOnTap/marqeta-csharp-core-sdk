...
#nullable enable
        public List<JournalEntry>? Data { get; set; }
#nullable restore
#else
        public List<JournalEntry> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="JournalEntriesPage"/> and sets the default values.
        /// </summary>
        ...
        public static JournalEntriesPage CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new JournalEntriesPage();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<JournalEntry>(JournalEntry.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<JournalEntry>("data", Data);
