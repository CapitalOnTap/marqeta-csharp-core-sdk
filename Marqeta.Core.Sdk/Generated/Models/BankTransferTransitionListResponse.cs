...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class BankTransferTransitionListResponse : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model>? Data { get; set; }
#nullable restore
#else
        public List<global::Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.BankTransferTransitionListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::Marqeta.Core.Sdk.Models.BankTransferTransitionListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.BankTransferTransitionListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "data", n => { Data = n.GetCollectionOfObjectValues<global::Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model>(global::Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model>("data", Data);
