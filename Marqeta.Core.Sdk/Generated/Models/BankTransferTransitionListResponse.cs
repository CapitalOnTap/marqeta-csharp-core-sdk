...
#nullable enable
        public List<Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model>? Data { get; set; }
#nullable restore
#else
        public List<Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.BankTransferTransitionListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static Marqeta.Core.Sdk.Models.BankTransferTransitionListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.BankTransferTransitionListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "data", n => { Data = n.GetCollectionOfObjectValues<Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model>(Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model>("data", Data);
