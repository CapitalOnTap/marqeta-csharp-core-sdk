...
namespace Marqeta.Core.Sdk.Models {
    public class Payment_card_funding_source_model : Funding_source_model, IParsable {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Payment_card_funding_source_model"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Payment_card_funding_source_model CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Payment_card_funding_source_model();
        }
        /// <summary>
