...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class StatementPaymentWarning : IAdditionalDataHolder, IParsable
    {
        ...
        public global::Marqeta.Core.Sdk.Models.StatementPaymentWarning_disclosure? Disclosure { get; set; }
        ...
        public global::Marqeta.Core.Sdk.Models.StatementPaymentWarning_period_type? PeriodType { get; set; }
        ...
        public global::Marqeta.Core.Sdk.Models.StatementPaymentWarning_type? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.StatementPaymentWarning"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Models.StatementPaymentWarning"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Marqeta.Core.Sdk.Models.StatementPaymentWarning CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.StatementPaymentWarning();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "disclosure", n => { Disclosure = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.StatementPaymentWarning_disclosure>(); } },
                ...
                { "period_type", n => { PeriodType = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.StatementPaymentWarning_period_type>(); } },
                { "total_paid", n => { TotalPaid = n.GetDoubleValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.StatementPaymentWarning_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.StatementPaymentWarning_disclosure>("disclosure", Disclosure);
            ...
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.StatementPaymentWarning_period_type>("period_type", PeriodType);
            writer.WriteDoubleValue("total_paid", TotalPaid);
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.StatementPaymentWarning_type>("type", Type);
