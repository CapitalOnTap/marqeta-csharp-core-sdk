...
#nullable enable
        public Marqeta.Core.Sdk.Models.Program_reserve_account_balance_balances? Balances { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.Program_reserve_account_balance_balances Balances { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.Program_reserve_account_balance"/> and sets the default values.
        /// </summary>
        ...
        public static Marqeta.Core.Sdk.Models.Program_reserve_account_balance CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.Program_reserve_account_balance();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "balances", n => { Balances = n.GetObjectValue<Marqeta.Core.Sdk.Models.Program_reserve_account_balance_balances>(Marqeta.Core.Sdk.Models.Program_reserve_account_balance_balances.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.Program_reserve_account_balance_balances>("balances", Balances);
