...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public class Gpa : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.Gpa"/> and sets the default values.
        /// </summary>
        public Gpa()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.Gpa"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Marqeta.Core.Sdk.Models.Gpa CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.Gpa();
        }
        /// <summary>
