...
#nullable enable
        public Marqeta.Core.Sdk.Models.PolicyAprResponse? AprPolicyDetail { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.PolicyAprResponse AprPolicyDetail { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.PolicyProductResponse? CreditProductPolicyDetail { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.PolicyProductResponse CreditProductPolicyDetail { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.PolicyDocumentResponse? DocumentPolicyDetail { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.PolicyDocumentResponse DocumentPolicyDetail { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.PolicyFeeResponse? FeePolicyDetail { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.PolicyFeeResponse FeePolicyDetail { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.PolicyOfferResponse? OfferPolicyDetail { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.PolicyOfferResponse OfferPolicyDetail { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.PolicyRewardResponse? RewardPolicyDetail { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.PolicyRewardResponse RewardPolicyDetail { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.BundleResponse"/> and sets the default values.
        /// </summary>
        ...
        public static Marqeta.Core.Sdk.Models.BundleResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.BundleResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "apr_policy_detail", n => { AprPolicyDetail = n.GetObjectValue<Marqeta.Core.Sdk.Models.PolicyAprResponse>(Marqeta.Core.Sdk.Models.PolicyAprResponse.CreateFromDiscriminatorValue); } },
                { "apr_policy_token", n => { AprPolicyToken = n.GetStringValue(); } },
                { "created_time", n => { CreatedTime = n.GetDateTimeOffsetValue(); } },
                { "credit_product_policy_detail", n => { CreditProductPolicyDetail = n.GetObjectValue<Marqeta.Core.Sdk.Models.PolicyProductResponse>(Marqeta.Core.Sdk.Models.PolicyProductResponse.CreateFromDiscriminatorValue); } },
                { "credit_product_policy_token", n => { CreditProductPolicyToken = n.GetStringValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "document_policy_detail", n => { DocumentPolicyDetail = n.GetObjectValue<Marqeta.Core.Sdk.Models.PolicyDocumentResponse>(Marqeta.Core.Sdk.Models.PolicyDocumentResponse.CreateFromDiscriminatorValue); } },
                { "document_policy_token", n => { DocumentPolicyToken = n.GetStringValue(); } },
                { "fee_policy_detail", n => { FeePolicyDetail = n.GetObjectValue<Marqeta.Core.Sdk.Models.PolicyFeeResponse>(Marqeta.Core.Sdk.Models.PolicyFeeResponse.CreateFromDiscriminatorValue); } },
                { "fee_policy_token", n => { FeePolicyToken = n.GetStringValue(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "offer_policy_detail", n => { OfferPolicyDetail = n.GetObjectValue<Marqeta.Core.Sdk.Models.PolicyOfferResponse>(Marqeta.Core.Sdk.Models.PolicyOfferResponse.CreateFromDiscriminatorValue); } },
                { "offer_policy_token", n => { OfferPolicyToken = n.GetStringValue(); } },
                { "reward_policy_detail", n => { RewardPolicyDetail = n.GetObjectValue<Marqeta.Core.Sdk.Models.PolicyRewardResponse>(Marqeta.Core.Sdk.Models.PolicyRewardResponse.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.PolicyAprResponse>("apr_policy_detail", AprPolicyDetail);
            writer.WriteStringValue("apr_policy_token", AprPolicyToken);
            writer.WriteDateTimeOffsetValue("created_time", CreatedTime);
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.PolicyProductResponse>("credit_product_policy_detail", CreditProductPolicyDetail);
            writer.WriteStringValue("credit_product_policy_token", CreditProductPolicyToken);
            writer.WriteStringValue("description", Description);
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.PolicyDocumentResponse>("document_policy_detail", DocumentPolicyDetail);
            writer.WriteStringValue("document_policy_token", DocumentPolicyToken);
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.PolicyFeeResponse>("fee_policy_detail", FeePolicyDetail);
            writer.WriteStringValue("fee_policy_token", FeePolicyToken);
            writer.WriteStringValue("name", Name);
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.PolicyOfferResponse>("offer_policy_detail", OfferPolicyDetail);
            writer.WriteStringValue("offer_policy_token", OfferPolicyToken);
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.PolicyRewardResponse>("reward_policy_detail", RewardPolicyDetail);
