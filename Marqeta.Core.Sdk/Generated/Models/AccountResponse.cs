...
#nullable restore
        ...
        public string BundleToken { get; set; }
#endif
        /// <summary>Substatuses of the business under the credit account.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<string>? BusinessSubstatuses { get; set; }
#nullable restore
#else
        public List<string> BusinessSubstatuses { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>Unique identifier of the secured account.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<string> UserSubstatuses { get; set; }
#endif
        /// <summary>Unique identifier of the primary account holder or an administrative user of a business account.Either a `user_token` or `business_token` is returned, not both.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "business_substatuses", n => { BusinessSubstatuses = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                ...
                { "secured_account_token", n => { SecuredAccountToken = n.GetStringValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfPrimitiveValues<string>("business_substatuses", BusinessSubstatuses);
            ...
            writer.WriteStringValue("secured_account_token", SecuredAccountToken);
