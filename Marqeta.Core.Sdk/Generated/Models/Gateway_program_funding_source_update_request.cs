...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Gateway_program_funding_source_update_request_custom_header? CustomHeader { get; set; }
#nullable restore
#else
        public Gateway_program_funding_source_update_request_custom_header CustomHeader { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="Gateway_program_funding_source_update_request"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Gateway_program_funding_source_update_request"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Gateway_program_funding_source_update_request CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Gateway_program_funding_source_update_request();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"custom_header", n => { CustomHeader = n.GetObjectValue<Gateway_program_funding_source_update_request_custom_header>(Gateway_program_funding_source_update_request_custom_header.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Gateway_program_funding_source_update_request_custom_header>("custom_header", CustomHeader);
