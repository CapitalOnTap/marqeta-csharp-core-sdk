...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Riskcontrol_tags>? RiskcontrolTags { get; set; }
#nullable restore
#else
        public List<Riskcontrol_tags> RiskcontrolTags { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Triggered_rule>? TriggeredRules { get; set; }
#nullable restore
#else
        public List<Triggered_rule> TriggeredRules { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="Issuer_fraud_view"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Issuer_fraud_view"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Issuer_fraud_view CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Issuer_fraud_view();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"riskcontrol_tags", n => { RiskcontrolTags = n.GetCollectionOfObjectValues<Riskcontrol_tags>(Riskcontrol_tags.CreateFromDiscriminatorValue)?.ToList(); } },
                {"rule_violations", n => { RuleViolations = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"score", n => { Score = n.GetIntValue(); } },
                {"triggered_rules", n => { TriggeredRules = n.GetCollectionOfObjectValues<Triggered_rule>(Triggered_rule.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Riskcontrol_tags>("riskcontrol_tags", RiskcontrolTags);
            ...
            writer.WriteCollectionOfObjectValues<Triggered_rule>("triggered_rules", TriggeredRules);
