...
#nullable enable
        public List<Bank_transfer_response_model>? Data { get; set; }
#nullable restore
#else
        public List<Bank_transfer_response_model> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="BankTransferListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static BankTransferListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BankTransferListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Bank_transfer_response_model>(Bank_transfer_response_model.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Bank_transfer_response_model>("data", Data);
