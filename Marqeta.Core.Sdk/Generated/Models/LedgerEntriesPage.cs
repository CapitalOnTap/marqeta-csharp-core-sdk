...
#nullable enable
        public List<LedgerEntry>? Data { get; set; }
#nullable restore
#else
        public List<LedgerEntry> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="LedgerEntriesPage"/> and sets the default values.
        /// </summary>
        ...
        public static LedgerEntriesPage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new LedgerEntriesPage();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<LedgerEntry>(LedgerEntry.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<LedgerEntry>("data", Data);
