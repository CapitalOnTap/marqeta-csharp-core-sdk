...
namespace Marqeta.Core.Sdk.Models {
    ...
    public class Gateway_program_custom_header_update_request_custom_header : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new <see cref="Gateway_program_custom_header_update_request_custom_header"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Gateway_program_custom_header_update_request_custom_header"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Gateway_program_custom_header_update_request_custom_header CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Gateway_program_custom_header_update_request_custom_header();
        }
        /// <summary>
