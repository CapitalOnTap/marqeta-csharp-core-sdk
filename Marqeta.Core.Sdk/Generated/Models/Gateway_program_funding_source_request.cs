...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Models.Gateway_program_funding_source_request"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Marqeta.Core.Sdk.Models.Gateway_program_funding_source_request CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.Gateway_program_funding_source_request();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "custom_header", n => { CustomHeader = n.GetObjectValue<global::Marqeta.Core.Sdk.Models.Gateway_program_funding_source_request_custom_header>(global::Marqeta.Core.Sdk.Models.Gateway_program_funding_source_request_custom_header.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Marqeta.Core.Sdk.Models.Gateway_program_funding_source_request_custom_header>("custom_header", CustomHeader);
