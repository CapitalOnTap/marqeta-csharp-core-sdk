...
#nullable enable
        public List<AprScheduleEntryCreateReq>? Schedule { get; set; }
#nullable restore
#else
        public List<AprScheduleEntryCreateReq> Schedule { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="AprScheduleCreateReq"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="AprScheduleCreateReq"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static AprScheduleCreateReq CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new AprScheduleCreateReq();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"schedule", n => { Schedule = n.GetCollectionOfObjectValues<AprScheduleEntryCreateReq>(AprScheduleEntryCreateReq.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<AprScheduleEntryCreateReq>("schedule", Schedule);
