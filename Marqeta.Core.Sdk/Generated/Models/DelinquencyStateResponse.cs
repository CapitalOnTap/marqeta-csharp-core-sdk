...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class DelinquencyStateResponse : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Marqeta.Core.Sdk.Models.DelinquencyBucketResponse>? Buckets { get; set; }
#nullable restore
#else
        public List<global::Marqeta.Core.Sdk.Models.DelinquencyBucketResponse> Buckets { get; set; }
#endif
        ...
        /// <summary>Total number of days that the account is past the oldest buckets statement end date</summary>
        public int? DelinquentDaysPastStatementEndDate { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.DelinquencyStateResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::Marqeta.Core.Sdk.Models.DelinquencyStateResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.DelinquencyStateResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "buckets", n => { Buckets = n.GetCollectionOfObjectValues<global::Marqeta.Core.Sdk.Models.DelinquencyBucketResponse>(global::Marqeta.Core.Sdk.Models.DelinquencyBucketResponse.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "delinquent_days_past_statement_end_date", n => { DelinquentDaysPastStatementEndDate = n.GetIntValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Marqeta.Core.Sdk.Models.DelinquencyBucketResponse>("buckets", Buckets);
            ...
            writer.WriteIntValue("delinquent_days_past_statement_end_date", DelinquentDaysPastStatementEndDate);
