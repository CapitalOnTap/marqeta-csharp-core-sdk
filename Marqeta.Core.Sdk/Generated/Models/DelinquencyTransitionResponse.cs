...
namespace Marqeta.Core.Sdk.Models
{
    ...
    /// </summary>
    public class DelinquencyTransitionResponse : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.DelinquencyStatus? OriginalStatus { get; set; }
        /// <summary>Delinquency status of an account.</summary>
        public Marqeta.Core.Sdk.Models.DelinquencyStatus? Status { get; set; }
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.DelinquencyTransitionTriggerReason? TransitionTriggerReason { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.DelinquencyTransitionResponse"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.DelinquencyTransitionResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Marqeta.Core.Sdk.Models.DelinquencyTransitionResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.DelinquencyTransitionResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "original_status", n => { OriginalStatus = n.GetEnumValue<Marqeta.Core.Sdk.Models.DelinquencyStatus>(); } },
                { "status", n => { Status = n.GetEnumValue<Marqeta.Core.Sdk.Models.DelinquencyStatus>(); } },
                { "token", n => { Token = n.GetStringValue(); } },
                { "total_due", n => { TotalDue = n.GetDoubleValue(); } },
                { "total_past_due", n => { TotalPastDue = n.GetDoubleValue(); } },
                { "transition_trigger_reason", n => { TransitionTriggerReason = n.GetEnumValue<Marqeta.Core.Sdk.Models.DelinquencyTransitionTriggerReason>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.DelinquencyStatus>("original_status", OriginalStatus);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.DelinquencyStatus>("status", Status);
            writer.WriteStringValue("token", Token);
            writer.WriteDoubleValue("total_due", TotalDue);
            writer.WriteDoubleValue("total_past_due", TotalPastDue);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.DelinquencyTransitionTriggerReason>("transition_trigger_reason", TransitionTriggerReason);
