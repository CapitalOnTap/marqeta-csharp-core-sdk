...
#nullable restore
        ...
        /// <summary>Delinquency status of an account.</summary>
        public DelinquencyStatus? Status { get; set; }
...
#nullable restore
        ...
        public DelinquencyTransitionTriggerReason? TransitionTriggerReason { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="DelinquencyTransitionResponse"/> and sets the default values.
        /// </summary>
        ...
        public static DelinquencyTransitionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DelinquencyTransitionResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"original_status", n => { OriginalStatus = n.GetEnumValue<DelinquencyStatus>(); } },
                {"status", n => { Status = n.GetEnumValue<DelinquencyStatus>(); } },
                {"token", n => { Token = n.GetStringValue(); } },
                {"total_due", n => { TotalDue = n.GetDoubleValue(); } },
                {"total_past_due", n => { TotalPastDue = n.GetDoubleValue(); } },
                {"transition_trigger_reason", n => { TransitionTriggerReason = n.GetEnumValue<DelinquencyTransitionTriggerReason>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<DelinquencyStatus>("original_status", OriginalStatus);
            writer.WriteEnumValue<DelinquencyStatus>("status", Status);
            writer.WriteStringValue("token", Token);
            writer.WriteDoubleValue("total_due", TotalDue);
            writer.WriteDoubleValue("total_past_due", TotalPastDue);
            writer.WriteEnumValue<DelinquencyTransitionTriggerReason>("transition_trigger_reason", TransitionTriggerReason);
