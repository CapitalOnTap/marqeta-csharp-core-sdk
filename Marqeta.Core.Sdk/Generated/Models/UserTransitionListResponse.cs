...
#nullable enable
        public List<UserTransitionResponse>? Data { get; set; }
#nullable restore
#else
        public List<UserTransitionResponse> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="UserTransitionListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static UserTransitionListResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UserTransitionListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<UserTransitionResponse>(UserTransitionResponse.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<UserTransitionResponse>("data", Data);
