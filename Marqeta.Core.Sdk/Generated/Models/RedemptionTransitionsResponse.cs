...
namespace Marqeta.Core.Sdk.Models {
    ...
    public class RedemptionTransitionsResponse : IAdditionalDataHolder, IParsable 
    {
        ...
        public RedemptionStatus? InitialStatus { get; set; }
        /// <summary>Status of the redemption.If &lt;&lt;/core-api/reward-redemptions#postRedemptionTransition, transitioning the redemption&apos;s status&gt;&gt;:* `new_state` is the state to which you want to transition the redemption; must be `COMPLETED` or `RETURNED`.* `initial_status` is the initial status of the redemption prior to transition.</summary>
        public RedemptionStatus? NewStatus { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="RedemptionTransitionsResponse"/> and sets the default values.
        /// </summary>
        ...
        public static RedemptionTransitionsResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new RedemptionTransitionsResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"initial_status", n => { InitialStatus = n.GetEnumValue<RedemptionStatus>(); } },
                {"new_status", n => { NewStatus = n.GetEnumValue<RedemptionStatus>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<RedemptionStatus>("initial_status", InitialStatus);
            writer.WriteEnumValue<RedemptionStatus>("new_status", NewStatus);
