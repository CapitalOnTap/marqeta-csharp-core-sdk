...
namespace Marqeta.Core.Sdk.Models {
    ...
    public class Account_holder_group_config : IAdditionalDataHolder, IParsable 
    {
        ...
        public Account_holder_group_config_kyc_required? KycRequired { get; set; }
...
#nullable enable
        public Pre_kyc_controls? PreKycControls { get; set; }
#nullable restore
#else
        public Pre_kyc_controls PreKycControls { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Account_holder_group_config"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Account_holder_group_config"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Account_holder_group_config CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Account_holder_group_config();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"kyc_required", n => { KycRequired = n.GetEnumValue<Account_holder_group_config_kyc_required>(); } },
                {"pre_kyc_controls", n => { PreKycControls = n.GetObjectValue<Pre_kyc_controls>(Pre_kyc_controls.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Account_holder_group_config_kyc_required>("kyc_required", KycRequired);
            writer.WriteObjectValue<Pre_kyc_controls>("pre_kyc_controls", PreKycControls);
