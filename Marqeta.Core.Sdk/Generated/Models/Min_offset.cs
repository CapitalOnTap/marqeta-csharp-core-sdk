...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class Min_offset : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Specifies the time unit of the `value` field.</summary>
        public global::Marqeta.Core.Sdk.Models.Min_offset_unit? Unit { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.Min_offset"/> and sets the default values.
        /// </summary>
        public Min_offset()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Models.Min_offset"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Marqeta.Core.Sdk.Models.Min_offset CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.Min_offset();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "unit", n => { Unit = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.Min_offset_unit>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.Min_offset_unit>("unit", Unit);
