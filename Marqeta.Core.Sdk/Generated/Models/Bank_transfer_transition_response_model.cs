...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model_channel? Channel { get; set; }
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model"/> and sets the default values.
        /// </summary>
        ...
        public static Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "channel", n => { Channel = n.GetEnumValue<Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model_channel>(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model_channel>("channel", Channel);
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Bank_transfer_transition_response_model_status>("status", Status);
