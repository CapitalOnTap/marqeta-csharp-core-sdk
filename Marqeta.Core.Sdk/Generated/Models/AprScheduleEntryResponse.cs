...
namespace Marqeta.Core.Sdk.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public Marqeta.Core.Sdk.Models.AprScheduleEntryResponse_type? Type { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.AprScheduleEntryResponse"/> and sets the default values.
        /// </summary>
        public AprScheduleEntryResponse()
        {
            AdditionalData = new Dictionary<string, object>();
            Type = Marqeta.Core.Sdk.Models.AprScheduleEntryResponse_type.FIXED;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.AprScheduleEntryResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Marqeta.Core.Sdk.Models.AprScheduleEntryResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.AprScheduleEntryResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "type", n => { Type = n.GetEnumValue<Marqeta.Core.Sdk.Models.AprScheduleEntryResponse_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.AprScheduleEntryResponse_type>("type", Type);
