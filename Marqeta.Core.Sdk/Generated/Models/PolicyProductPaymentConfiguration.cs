...
#nullable enable
        public List<PaymentAllocationOrderEnum?>? AllocationOrder { get; set; }
#nullable restore
#else
        public List<PaymentAllocationOrderEnum?> AllocationOrder { get; set; }
#endif
...
#nullable restore
        ...
        public PolicyProductPaymentConfiguration()
        {
            ...
            BillingCycleDayStrategy = PolicyProductPaymentConfiguration_billing_cycle_day_strategy.MANUAL;
            BillingCycleFrequency = PolicyProductPaymentConfiguration_billing_cycle_frequency.MONTHLY;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="PolicyProductPaymentConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PolicyProductPaymentConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PolicyProductPaymentConfiguration();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"allocation_order", n => { AllocationOrder = n.GetCollectionOfEnumValues<PaymentAllocationOrderEnum>()?.ToList(); } },
                {"billing_cycle_day", n => { BillingCycleDay = n.GetIntValue(); } },
                {"billing_cycle_day_strategy", n => { BillingCycleDayStrategy = n.GetEnumValue<PolicyProductPaymentConfiguration_billing_cycle_day_strategy>(); } },
                {"billing_cycle_frequency", n => { BillingCycleFrequency = n.GetEnumValue<PolicyProductPaymentConfiguration_billing_cycle_frequency>(); } },
                {"due_day", n => { DueDay = n.GetIntValue(); } },
                {"min_payment_calculation", n => { MinPaymentCalculation = n.GetObjectValue<PolicyProductMinPaymentCalculation>(PolicyProductMinPaymentCalculation.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<PaymentAllocationOrderEnum>("allocation_order", AllocationOrder);
            writer.WriteIntValue("billing_cycle_day", BillingCycleDay);
            writer.WriteEnumValue<PolicyProductPaymentConfiguration_billing_cycle_day_strategy>("billing_cycle_day_strategy", BillingCycleDayStrategy);
            writer.WriteEnumValue<PolicyProductPaymentConfiguration_billing_cycle_frequency>("billing_cycle_frequency", BillingCycleFrequency);
            writer.WriteIntValue("due_day", DueDay);
            writer.WriteObjectValue<PolicyProductMinPaymentCalculation>("min_payment_calculation", MinPaymentCalculation);
