...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.AccountConfigReq? Config { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.AccountConfigReq Config { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Marqeta.Core.Sdk.Models.AccountUsageCreateReq>? Usages { get; set; }
#nullable restore
#else
        public List<Marqeta.Core.Sdk.Models.AccountUsageCreateReq> Usages { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.AccountCreateReq"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.AccountCreateReq"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Marqeta.Core.Sdk.Models.AccountCreateReq CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.AccountCreateReq();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "config", n => { Config = n.GetObjectValue<Marqeta.Core.Sdk.Models.AccountConfigReq>(Marqeta.Core.Sdk.Models.AccountConfigReq.CreateFromDiscriminatorValue); } },
                ...
                { "usages", n => { Usages = n.GetCollectionOfObjectValues<Marqeta.Core.Sdk.Models.AccountUsageCreateReq>(Marqeta.Core.Sdk.Models.AccountUsageCreateReq.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.AccountConfigReq>("config", Config);
            ...
            writer.WriteCollectionOfObjectValues<Marqeta.Core.Sdk.Models.AccountUsageCreateReq>("usages", Usages);
