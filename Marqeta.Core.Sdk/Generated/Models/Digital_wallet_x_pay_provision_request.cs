...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Digital_wallet_x_pay_provision_request_device_type? DeviceType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.Digital_wallet_x_pay_provision_request"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.Digital_wallet_x_pay_provision_request"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Marqeta.Core.Sdk.Models.Digital_wallet_x_pay_provision_request CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.Digital_wallet_x_pay_provision_request();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "device_type", n => { DeviceType = n.GetEnumValue<Marqeta.Core.Sdk.Models.Digital_wallet_x_pay_provision_request_device_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Digital_wallet_x_pay_provision_request_device_type>("device_type", DeviceType);
