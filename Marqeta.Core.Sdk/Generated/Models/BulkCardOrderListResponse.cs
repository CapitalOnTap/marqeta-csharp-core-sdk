...
#nullable enable
        public List<Bulk_issuance_response>? Data { get; set; }
#nullable restore
#else
        public List<Bulk_issuance_response> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="BulkCardOrderListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static BulkCardOrderListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BulkCardOrderListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Bulk_issuance_response>(Bulk_issuance_response.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Bulk_issuance_response>("data", Data);
