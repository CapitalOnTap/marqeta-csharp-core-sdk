...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public class BulkCardOrderListResponse : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<Marqeta.Core.Sdk.Models.Bulk_issuance_response>? Data { get; set; }
#nullable restore
#else
        public List<Marqeta.Core.Sdk.Models.Bulk_issuance_response> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.BulkCardOrderListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static Marqeta.Core.Sdk.Models.BulkCardOrderListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.BulkCardOrderListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "data", n => { Data = n.GetCollectionOfObjectValues<Marqeta.Core.Sdk.Models.Bulk_issuance_response>(Marqeta.Core.Sdk.Models.Bulk_issuance_response.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Marqeta.Core.Sdk.Models.Bulk_issuance_response>("data", Data);
