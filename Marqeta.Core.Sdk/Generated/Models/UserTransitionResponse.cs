...
namespace Marqeta.Core.Sdk.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public Marqeta.Core.Sdk.Models.UserTransitionResponse_channel? Channel { get; set; }
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.UserTransitionResponse_reason_code? ReasonCode { get; set; }
        /// <summary>Specifies the new status of the user.</summary>
        public Marqeta.Core.Sdk.Models.UserTransitionResponse_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.UserTransitionResponse"/> and sets the default values.
        /// </summary>
        ...
        public static Marqeta.Core.Sdk.Models.UserTransitionResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.UserTransitionResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "channel", n => { Channel = n.GetEnumValue<Marqeta.Core.Sdk.Models.UserTransitionResponse_channel>(); } },
                { "created_time", n => { CreatedTime = n.GetDateTimeOffsetValue(); } },
                { "last_modified_time", n => { LastModifiedTime = n.GetDateTimeOffsetValue(); } },
                { "reason", n => { Reason = n.GetStringValue(); } },
                { "reason_code", n => { ReasonCode = n.GetEnumValue<Marqeta.Core.Sdk.Models.UserTransitionResponse_reason_code>(); } },
                { "status", n => { Status = n.GetEnumValue<Marqeta.Core.Sdk.Models.UserTransitionResponse_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.UserTransitionResponse_channel>("channel", Channel);
            writer.WriteDateTimeOffsetValue("created_time", CreatedTime);
            writer.WriteDateTimeOffsetValue("last_modified_time", LastModifiedTime);
            writer.WriteStringValue("reason", Reason);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.UserTransitionResponse_reason_code>("reason_code", ReasonCode);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.UserTransitionResponse_status>("status", Status);
