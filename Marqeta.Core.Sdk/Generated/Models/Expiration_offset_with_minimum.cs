...
#nullable enable
        public Min_offset? MinOffset { get; set; }
#nullable restore
#else
        public Min_offset MinOffset { get; set; }
#endif
        /// <summary>Specifies the units for the `value` field.</summary>
        public Expiration_offset_with_minimum_unit? Unit { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="Expiration_offset_with_minimum"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Expiration_offset_with_minimum"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Expiration_offset_with_minimum CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Expiration_offset_with_minimum();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"min_offset", n => { MinOffset = n.GetObjectValue<Min_offset>(Min_offset.CreateFromDiscriminatorValue); } },
                {"unit", n => { Unit = n.GetEnumValue<Expiration_offset_with_minimum_unit>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Min_offset>("min_offset", MinOffset);
            writer.WriteEnumValue<Expiration_offset_with_minimum_unit>("unit", Unit);
