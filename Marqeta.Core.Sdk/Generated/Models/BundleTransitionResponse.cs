...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.BundleResourceStatus? OriginalStatus { get; set; }
        /// <summary>Status of the bundle.* `DRAFT` - The bundle is in the process of being created.* `PENDING_APPROVAL` - The bundle has been created and is awaiting approval.* `SENT_FOR_REVISION` - The bundle has been returned for revision.* `ACTIVE` - The bundle is active.* `REJECTED` - The bundle has been rejected; this status cannot be changed.* `ARCHIVED` - The previously active bundle has been archived.* `APPROVED` - The bundle has been approved (after having been sent for approval).</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.BundleTransitionResponse"/> and sets the default values.
        /// </summary>
        ...
        public static Marqeta.Core.Sdk.Models.BundleTransitionResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.BundleTransitionResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "original_status", n => { OriginalStatus = n.GetEnumValue<Marqeta.Core.Sdk.Models.BundleResourceStatus>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.BundleResourceStatus>("original_status", OriginalStatus);
