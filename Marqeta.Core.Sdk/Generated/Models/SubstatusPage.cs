...
#nullable enable
        public List<SubstatusResponse>? Data { get; set; }
#nullable restore
#else
        public List<SubstatusResponse> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="SubstatusPage"/> and sets the default values.
        /// </summary>
        ...
        public static SubstatusPage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SubstatusPage();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<SubstatusResponse>(SubstatusResponse.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<SubstatusResponse>("data", Data);
