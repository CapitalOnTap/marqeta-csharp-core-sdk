...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class AccountConfigResponse : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>Day of the month when the billing cycle starts.If an override value is not provided, the default value is derived from the bundle.</summary>
...
#nullable restore
        ...
        public global::Marqeta.Core.Sdk.Models.AccountConfigMinPayment MinPayment { get; set; }
#endif
        /// <summary>Day of the month when the payment for the previous billing cycle is due.</summary>
        [Obsolete("")]
        public int? PaymentDueDay { get; set; }
        /// <summary>Specifies the payment due interval that is used to determine the payment due date for a billing cycle.A value of -1 indicates one day prior to the next billing cycle date.</summary>
