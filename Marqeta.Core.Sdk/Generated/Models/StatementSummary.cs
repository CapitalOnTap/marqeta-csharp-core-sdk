...
#nullable restore
        ...
        /// <summary>Minimum payment that is due.</summary>
        public double? MinPaymentDue { get; set; }
        ...
        /// <summary>Total amount of the payment required to make the account current.</summary>
        public double? PastDueAmount { get; set; }
        /// <summary>Date when the payment was due for this statement period.</summary>
        ...
        /// <summary>Amount of the minimum payment that remains unpaid for the previous statement period.</summary>
        public double? RemainingMinPaymentDue { get; set; }
        /// <summary>Amount of the statement balance that remains unpaid for the previous statement period.</summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "min_payment_due", n => { MinPaymentDue = n.GetDoubleValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteDoubleValue("min_payment_due", MinPaymentDue);
