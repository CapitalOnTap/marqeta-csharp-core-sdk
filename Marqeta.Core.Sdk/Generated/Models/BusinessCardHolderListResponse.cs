...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public class BusinessCardHolderListResponse : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<Marqeta.Core.Sdk.Models.Business_cardholder>? Data { get; set; }
#nullable restore
#else
        public List<Marqeta.Core.Sdk.Models.Business_cardholder> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.BusinessCardHolderListResponse"/> and sets the default values.
        /// </summary>
        public BusinessCardHolderListResponse()
        {
        ...
        public static Marqeta.Core.Sdk.Models.BusinessCardHolderListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.BusinessCardHolderListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "data", n => { Data = n.GetCollectionOfObjectValues<Marqeta.Core.Sdk.Models.Business_cardholder>(Marqeta.Core.Sdk.Models.Business_cardholder.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Marqeta.Core.Sdk.Models.Business_cardholder>("data", Data);
