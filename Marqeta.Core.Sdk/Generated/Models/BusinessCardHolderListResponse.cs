...
#nullable enable
        public List<Business_cardholder>? Data { get; set; }
#nullable restore
#else
        public List<Business_cardholder> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="BusinessCardHolderListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static BusinessCardHolderListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BusinessCardHolderListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Business_cardholder>(Business_cardholder.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Business_cardholder>("data", Data);
