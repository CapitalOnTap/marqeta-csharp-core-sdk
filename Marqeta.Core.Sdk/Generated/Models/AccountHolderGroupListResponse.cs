...
#nullable enable
        public List<Account_holder_group_response>? Data { get; set; }
#nullable restore
#else
        public List<Account_holder_group_response> Data { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="AccountHolderGroupListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static AccountHolderGroupListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new AccountHolderGroupListResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Account_holder_group_response>(Account_holder_group_response.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Account_holder_group_response>("data", Data);
