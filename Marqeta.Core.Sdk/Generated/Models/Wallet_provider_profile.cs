...
#nullable enable
        public Marqeta.Core.Sdk.Models.Account? Account { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.Account Account { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.Risk_assessment? RiskAssessment { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.Risk_assessment RiskAssessment { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.Wallet_provider_profile"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.Wallet_provider_profile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Marqeta.Core.Sdk.Models.Wallet_provider_profile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.Wallet_provider_profile();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "recommendation_reasons", n => { RecommendationReasons = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                { "risk_assessment", n => { RiskAssessment = n.GetObjectValue<Marqeta.Core.Sdk.Models.Risk_assessment>(Marqeta.Core.Sdk.Models.Risk_assessment.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.Risk_assessment>("risk_assessment", RiskAssessment);
