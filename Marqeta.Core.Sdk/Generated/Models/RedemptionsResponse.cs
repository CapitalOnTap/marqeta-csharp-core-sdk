...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class RedemptionsResponse : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Marqeta.Core.Sdk.Models.RewardProgramsEntriesResponse>? RelatedRewardEntries { get; set; }
#nullable restore
#else
        public List<global::Marqeta.Core.Sdk.Models.RewardProgramsEntriesResponse> RelatedRewardEntries { get; set; }
#endif
...
#nullable restore
        ...
        public global::Marqeta.Core.Sdk.Models.RedemptionStatus? Status { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.RedemptionsResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::Marqeta.Core.Sdk.Models.RedemptionsResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.RedemptionsResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "related_reward_entries", n => { RelatedRewardEntries = n.GetCollectionOfObjectValues<global::Marqeta.Core.Sdk.Models.RewardProgramsEntriesResponse>(global::Marqeta.Core.Sdk.Models.RewardProgramsEntriesResponse.CreateFromDiscriminatorValue)?.AsList(); } },
                { "reward_program_token", n => { RewardProgramToken = n.GetStringValue(); } },
                { "sor_reward_token", n => { SorRewardToken = n.GetStringValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.RedemptionStatus>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Marqeta.Core.Sdk.Models.RewardProgramsEntriesResponse>("related_reward_entries", RelatedRewardEntries);
            writer.WriteStringValue("reward_program_token", RewardProgramToken);
            writer.WriteStringValue("sor_reward_token", SorRewardToken);
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.RedemptionStatus>("status", Status);
