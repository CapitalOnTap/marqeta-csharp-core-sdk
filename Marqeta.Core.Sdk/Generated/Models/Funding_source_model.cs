...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Funding_source_model"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Funding_source_model"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Funding_source_model CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("type")?.GetStringValue();
            return mappingValue switch
            {
                "bankaccount" => new Bank_account_funding_source_model(),
                "chargeback" => new Chargeback_funding_source_model(),
                "directdeposit" => new Direct_deposit_funding_source_model(),
                "paymentcard" => new Payment_card_funding_source_model(),
                "program" => new Program_funding_source_model(),
                "programgateway" => new Program_gateway_funding_source_model(),
                _ => new Funding_source_model(),
            };
        }
        /// <summary>
