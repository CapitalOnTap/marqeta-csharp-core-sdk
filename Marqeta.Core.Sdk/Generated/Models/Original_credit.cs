...
namespace Marqeta.Core.Sdk.Models {
    ...
    public class Original_credit : IAdditionalDataHolder, IParsable 
    {
        ...
        public Original_credit_deferred_hold_by? DeferredHoldBy { get; set; }
        ...
        public Original_credit_funding_source? FundingSource { get; set; }
...
#nullable restore
        ...
        public Original_credit_sender_account_type? SenderAccountType { get; set; }
...
#nullable restore
        ...
        public Original_credit_transaction_type? TransactionType { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="Original_credit"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Original_credit"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Original_credit CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Original_credit();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"deferred_hold_by", n => { DeferredHoldBy = n.GetEnumValue<Original_credit_deferred_hold_by>(); } },
                {"fast_funds_enabled", n => { FastFundsEnabled = n.GetBoolValue(); } },
                {"funding_source", n => { FundingSource = n.GetEnumValue<Original_credit_funding_source>(); } },
                {"screening_score", n => { ScreeningScore = n.GetStringValue(); } },
                {"sender_account_type", n => { SenderAccountType = n.GetEnumValue<Original_credit_sender_account_type>(); } },
                ...
                {"transaction_type", n => { TransactionType = n.GetEnumValue<Original_credit_transaction_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Original_credit_deferred_hold_by>("deferred_hold_by", DeferredHoldBy);
            writer.WriteBoolValue("fast_funds_enabled", FastFundsEnabled);
            writer.WriteEnumValue<Original_credit_funding_source>("funding_source", FundingSource);
            writer.WriteStringValue("screening_score", ScreeningScore);
            writer.WriteEnumValue<Original_credit_sender_account_type>("sender_account_type", SenderAccountType);
            ...
            writer.WriteEnumValue<Original_credit_transaction_type>("transaction_type", TransactionType);
