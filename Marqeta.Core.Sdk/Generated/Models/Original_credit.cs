...
namespace Marqeta.Core.Sdk.Models
{
    ...
    /// </summary>
    public class Original_credit : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The deferred_hold_by property</summary>
        public Marqeta.Core.Sdk.Models.Original_credit_deferred_hold_by? DeferredHoldBy { get; set; }
        ...
        public Marqeta.Core.Sdk.Models.Original_credit_funding_source? FundingSource { get; set; }
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Original_credit_sender_account_type? SenderAccountType { get; set; }
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Original_credit_transaction_type? TransactionType { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.Original_credit"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.Original_credit"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Marqeta.Core.Sdk.Models.Original_credit CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.Original_credit();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "deferred_hold_by", n => { DeferredHoldBy = n.GetEnumValue<Marqeta.Core.Sdk.Models.Original_credit_deferred_hold_by>(); } },
                { "fast_funds_enabled", n => { FastFundsEnabled = n.GetBoolValue(); } },
                { "funding_source", n => { FundingSource = n.GetEnumValue<Marqeta.Core.Sdk.Models.Original_credit_funding_source>(); } },
                { "screening_score", n => { ScreeningScore = n.GetStringValue(); } },
                { "sender_account_type", n => { SenderAccountType = n.GetEnumValue<Marqeta.Core.Sdk.Models.Original_credit_sender_account_type>(); } },
                ...
                { "transaction_type", n => { TransactionType = n.GetEnumValue<Marqeta.Core.Sdk.Models.Original_credit_transaction_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Original_credit_deferred_hold_by>("deferred_hold_by", DeferredHoldBy);
            writer.WriteBoolValue("fast_funds_enabled", FastFundsEnabled);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Original_credit_funding_source>("funding_source", FundingSource);
            writer.WriteStringValue("screening_score", ScreeningScore);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Original_credit_sender_account_type>("sender_account_type", SenderAccountType);
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Original_credit_transaction_type>("transaction_type", TransactionType);
