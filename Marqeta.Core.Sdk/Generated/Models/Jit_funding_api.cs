...
#nullable enable
        public Marqeta.Core.Sdk.Models.Jit_account_name_verification? AccountNameVerification { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.Jit_account_name_verification AccountNameVerification { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.Jit_address_verification? AddressVerification { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.Jit_address_verification AddressVerification { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.Jit_funding_api_balances? Balances { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.Jit_funding_api_balances Balances { get; set; }
#endif
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Jit_funding_api_decline_reason? DeclineReason { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.Jit_account_name_verification? JitAccountNameVerification { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.Jit_account_name_verification JitAccountNameVerification { get; set; }
#endif
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Jit_funding_api_method? Method { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.Jit_funding_api"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.Jit_funding_api"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Marqeta.Core.Sdk.Models.Jit_funding_api CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.Jit_funding_api();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "account_name_verification", n => { AccountNameVerification = n.GetObjectValue<Marqeta.Core.Sdk.Models.Jit_account_name_verification>(Marqeta.Core.Sdk.Models.Jit_account_name_verification.CreateFromDiscriminatorValue); } },
                { "acting_user_token", n => { ActingUserToken = n.GetStringValue(); } },
                { "address_verification", n => { AddressVerification = n.GetObjectValue<Marqeta.Core.Sdk.Models.Jit_address_verification>(Marqeta.Core.Sdk.Models.Jit_address_verification.CreateFromDiscriminatorValue); } },
                { "amount", n => { Amount = n.GetDoubleValue(); } },
                { "balances", n => { Balances = n.GetObjectValue<Marqeta.Core.Sdk.Models.Jit_funding_api_balances>(Marqeta.Core.Sdk.Models.Jit_funding_api_balances.CreateFromDiscriminatorValue); } },
                { "business_token", n => { BusinessToken = n.GetStringValue(); } },
                { "decline_reason", n => { DeclineReason = n.GetEnumValue<Marqeta.Core.Sdk.Models.Jit_funding_api_decline_reason>(); } },
                ...
                { "jit_account_name_verification", n => { JitAccountNameVerification = n.GetObjectValue<Marqeta.Core.Sdk.Models.Jit_account_name_verification>(Marqeta.Core.Sdk.Models.Jit_account_name_verification.CreateFromDiscriminatorValue); } },
                { "memo", n => { Memo = n.GetStringValue(); } },
                { "method", n => { Method = n.GetEnumValue<Marqeta.Core.Sdk.Models.Jit_funding_api_method>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.Jit_account_name_verification>("account_name_verification", AccountNameVerification);
            writer.WriteStringValue("acting_user_token", ActingUserToken);
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.Jit_address_verification>("address_verification", AddressVerification);
            writer.WriteDoubleValue("amount", Amount);
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.Jit_funding_api_balances>("balances", Balances);
            writer.WriteStringValue("business_token", BusinessToken);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Jit_funding_api_decline_reason>("decline_reason", DeclineReason);
            ...
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.Jit_account_name_verification>("jit_account_name_verification", JitAccountNameVerification);
            writer.WriteStringValue("memo", Memo);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Jit_funding_api_method>("method", Method);
