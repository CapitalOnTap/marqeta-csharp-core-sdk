...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public class Velocity_control_response : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Velocity_control_response_velocity_window? VelocityWindow { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.Velocity_control_response"/> and sets the default values.
        /// </summary>
        ...
        public static Marqeta.Core.Sdk.Models.Velocity_control_response CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.Velocity_control_response();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "velocity_window", n => { VelocityWindow = n.GetEnumValue<Marqeta.Core.Sdk.Models.Velocity_control_response_velocity_window>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Velocity_control_response_velocity_window>("velocity_window", VelocityWindow);
