...
#nullable restore
        ...
        public string Eligible { get; set; }
#endif
        /// <summary>Specifies which of the payment instrument&apos;s credentials is eligible for this transaction:* A value of `DEBIT` indicates the primary credential.* A value of `LOAN` indicates the secondary credential.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "action", n => { Action = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.Flex_action>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.Flex_action>("action", Action);
