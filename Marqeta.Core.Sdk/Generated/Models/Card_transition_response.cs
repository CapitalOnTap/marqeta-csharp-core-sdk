...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public class Card_transition_response : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.Card_metadata? Card { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.Card_metadata Card { get; set; }
#endif
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Card_transition_response_channel? Channel { get; set; }
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Card_transition_response_fulfillment_status? FulfillmentStatus { get; set; }
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Card_transition_response_reason_code? ReasonCode { get; set; }
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Card_transition_response_state? State { get; set; }
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Card_transition_response_type? Type { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.ValidationsResponse? Validations { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.ValidationsResponse Validations { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.Card_transition_response"/> and sets the default values.
        /// </summary>
        ...
        public static Marqeta.Core.Sdk.Models.Card_transition_response CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.Card_transition_response();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "card", n => { Card = n.GetObjectValue<Marqeta.Core.Sdk.Models.Card_metadata>(Marqeta.Core.Sdk.Models.Card_metadata.CreateFromDiscriminatorValue); } },
                { "card_product_token", n => { CardProductToken = n.GetStringValue(); } },
                { "card_token", n => { CardToken = n.GetStringValue(); } },
                { "channel", n => { Channel = n.GetEnumValue<Marqeta.Core.Sdk.Models.Card_transition_response_channel>(); } },
                ...
                { "fulfillment_status", n => { FulfillmentStatus = n.GetEnumValue<Marqeta.Core.Sdk.Models.Card_transition_response_fulfillment_status>(); } },
                ...
                { "reason_code", n => { ReasonCode = n.GetEnumValue<Marqeta.Core.Sdk.Models.Card_transition_response_reason_code>(); } },
                { "reissue_pan_from_card_token", n => { ReissuePanFromCardToken = n.GetStringValue(); } },
                { "state", n => { State = n.GetEnumValue<Marqeta.Core.Sdk.Models.Card_transition_response_state>(); } },
                { "token", n => { Token = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<Marqeta.Core.Sdk.Models.Card_transition_response_type>(); } },
                ...
                { "validations", n => { Validations = n.GetObjectValue<Marqeta.Core.Sdk.Models.ValidationsResponse>(Marqeta.Core.Sdk.Models.ValidationsResponse.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.Card_metadata>("card", Card);
            writer.WriteStringValue("card_product_token", CardProductToken);
            writer.WriteStringValue("card_token", CardToken);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Card_transition_response_channel>("channel", Channel);
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Card_transition_response_fulfillment_status>("fulfillment_status", FulfillmentStatus);
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Card_transition_response_reason_code>("reason_code", ReasonCode);
            writer.WriteStringValue("reissue_pan_from_card_token", ReissuePanFromCardToken);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Card_transition_response_state>("state", State);
            writer.WriteStringValue("token", Token);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Card_transition_response_type>("type", Type);
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.Cardholder_metadata>("user", User);
            writer.WriteStringValue("user_token", UserToken);
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.ValidationsResponse>("validations", Validations);
