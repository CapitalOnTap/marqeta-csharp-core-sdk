...
#nullable restore
        ...
        public Card_transition_response_channel? Channel { get; set; }
...
#nullable restore
        ...
        public Card_transition_response_fulfillment_status? FulfillmentStatus { get; set; }
...
#nullable restore
        ...
        public Card_transition_response_reason_code? ReasonCode { get; set; }
...
#nullable restore
        ...
        public Card_transition_response_state? State { get; set; }
...
#nullable restore
        ...
        public Card_transition_response_type? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Card_transition_response"/> and sets the default values.
        /// </summary>
        ...
        public static Card_transition_response CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Card_transition_response();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"card", n => { Card = n.GetObjectValue<Card_metadata>(Card_metadata.CreateFromDiscriminatorValue); } },
                {"card_product_token", n => { CardProductToken = n.GetStringValue(); } },
                {"card_token", n => { CardToken = n.GetStringValue(); } },
                {"channel", n => { Channel = n.GetEnumValue<Card_transition_response_channel>(); } },
                ...
                {"fulfillment_status", n => { FulfillmentStatus = n.GetEnumValue<Card_transition_response_fulfillment_status>(); } },
                ...
                {"reason_code", n => { ReasonCode = n.GetEnumValue<Card_transition_response_reason_code>(); } },
                {"reissue_pan_from_card_token", n => { ReissuePanFromCardToken = n.GetStringValue(); } },
                {"state", n => { State = n.GetEnumValue<Card_transition_response_state>(); } },
                {"token", n => { Token = n.GetStringValue(); } },
                {"type", n => { Type = n.GetEnumValue<Card_transition_response_type>(); } },
                {"user", n => { User = n.GetObjectValue<Cardholder_metadata>(Cardholder_metadata.CreateFromDiscriminatorValue); } },
                {"user_token", n => { UserToken = n.GetStringValue(); } },
                {"validations", n => { Validations = n.GetObjectValue<ValidationsResponse>(ValidationsResponse.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Card_metadata>("card", Card);
            writer.WriteStringValue("card_product_token", CardProductToken);
            writer.WriteStringValue("card_token", CardToken);
            writer.WriteEnumValue<Card_transition_response_channel>("channel", Channel);
            ...
            writer.WriteEnumValue<Card_transition_response_fulfillment_status>("fulfillment_status", FulfillmentStatus);
            ...
            writer.WriteEnumValue<Card_transition_response_reason_code>("reason_code", ReasonCode);
            writer.WriteStringValue("reissue_pan_from_card_token", ReissuePanFromCardToken);
            writer.WriteEnumValue<Card_transition_response_state>("state", State);
            writer.WriteStringValue("token", Token);
            writer.WriteEnumValue<Card_transition_response_type>("type", Type);
            writer.WriteObjectValue<Cardholder_metadata>("user", User);
            writer.WriteStringValue("user_token", UserToken);
            writer.WriteObjectValue<ValidationsResponse>("validations", Validations);
