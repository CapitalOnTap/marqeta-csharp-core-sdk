...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class CreateApplicationsRequest : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest_meta_data? MetaData { get; set; }
#nullable restore
#else
        public global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest_meta_data MetaData { get; set; }
#endif
...
#nullable restore
        ...
        public global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest_primary_income_source? PrimaryIncomeSource { get; set; }
...
#nullable restore
        ...
        public global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest_residence_type? ResidenceType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "meta_data", n => { MetaData = n.GetObjectValue<global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest_meta_data>(global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest_meta_data.CreateFromDiscriminatorValue); } },
                ...
                { "primary_income_source", n => { PrimaryIncomeSource = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest_primary_income_source>(); } },
                { "privacy_policy_tracking_token", n => { PrivacyPolicyTrackingToken = n.GetStringValue(); } },
                { "residence_type", n => { ResidenceType = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest_residence_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest_meta_data>("meta_data", MetaData);
            ...
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest_primary_income_source>("primary_income_source", PrimaryIncomeSource);
            writer.WriteStringValue("privacy_policy_tracking_token", PrivacyPolicyTrackingToken);
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.CreateApplicationsRequest_residence_type>("residence_type", ResidenceType);
