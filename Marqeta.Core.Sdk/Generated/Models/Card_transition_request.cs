...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Card_transition_request_channel? Channel { get; set; }
...
#nullable restore
        ...
        public Marqeta.Core.Sdk.Models.Card_transition_request_reason_code? ReasonCode { get; set; }
        /// <summary>Specifies the new state.</summary>
        public Marqeta.Core.Sdk.Models.Card_transition_request_state? State { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Marqeta.Core.Sdk.Models.ValidationsRequest? Validations { get; set; }
#nullable restore
#else
        public Marqeta.Core.Sdk.Models.ValidationsRequest Validations { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Models.Card_transition_request"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Models.Card_transition_request"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Marqeta.Core.Sdk.Models.Card_transition_request CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Marqeta.Core.Sdk.Models.Card_transition_request();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "channel", n => { Channel = n.GetEnumValue<Marqeta.Core.Sdk.Models.Card_transition_request_channel>(); } },
                { "reason", n => { Reason = n.GetStringValue(); } },
                { "reason_code", n => { ReasonCode = n.GetEnumValue<Marqeta.Core.Sdk.Models.Card_transition_request_reason_code>(); } },
                { "state", n => { State = n.GetEnumValue<Marqeta.Core.Sdk.Models.Card_transition_request_state>(); } },
                { "sync_state_with_dwts", n => { SyncStateWithDwts = n.GetBoolValue(); } },
                { "token", n => { Token = n.GetStringValue(); } },
                { "validations", n => { Validations = n.GetObjectValue<Marqeta.Core.Sdk.Models.ValidationsRequest>(Marqeta.Core.Sdk.Models.ValidationsRequest.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Card_transition_request_channel>("channel", Channel);
            writer.WriteStringValue("reason", Reason);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Card_transition_request_reason_code>("reason_code", ReasonCode);
            writer.WriteEnumValue<Marqeta.Core.Sdk.Models.Card_transition_request_state>("state", State);
            writer.WriteBoolValue("sync_state_with_dwts", SyncStateWithDwts);
            writer.WriteStringValue("token", Token);
            writer.WriteObjectValue<Marqeta.Core.Sdk.Models.ValidationsRequest>("validations", Validations);
