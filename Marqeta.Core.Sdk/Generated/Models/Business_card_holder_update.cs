...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class Business_card_holder_update : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Marqeta.Core.Sdk.Models.Business_card_holder_update_metadata? Metadata { get; set; }
#nullable restore
#else
        public global::Marqeta.Core.Sdk.Models.Business_card_holder_update_metadata Metadata { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.Business_card_holder_update"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Models.Business_card_holder_update"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Marqeta.Core.Sdk.Models.Business_card_holder_update CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.Business_card_holder_update();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "beneficial_owner1", n => { BeneficialOwner1 = n.GetObjectValue<global::Marqeta.Core.Sdk.Models.Beneficial_owner_request>(global::Marqeta.Core.Sdk.Models.Beneficial_owner_request.CreateFromDiscriminatorValue); } },
                { "beneficial_owner2", n => { BeneficialOwner2 = n.GetObjectValue<global::Marqeta.Core.Sdk.Models.Beneficial_owner_request>(global::Marqeta.Core.Sdk.Models.Beneficial_owner_request.CreateFromDiscriminatorValue); } },
                { "beneficial_owner3", n => { BeneficialOwner3 = n.GetObjectValue<global::Marqeta.Core.Sdk.Models.Beneficial_owner_request>(global::Marqeta.Core.Sdk.Models.Beneficial_owner_request.CreateFromDiscriminatorValue); } },
                { "beneficial_owner4", n => { BeneficialOwner4 = n.GetObjectValue<global::Marqeta.Core.Sdk.Models.Beneficial_owner_request>(global::Marqeta.Core.Sdk.Models.Beneficial_owner_request.CreateFromDiscriminatorValue); } },
                ...
                { "incorporation", n => { Incorporation = n.GetObjectValue<global::Marqeta.Core.Sdk.Models.Business_incorporation>(global::Marqeta.Core.Sdk.Models.Business_incorporation.CreateFromDiscriminatorValue); } },
                { "international_office_locations", n => { InternationalOfficeLocations = n.GetStringValue(); } },
                { "ip_address", n => { IpAddress = n.GetStringValue(); } },
                { "metadata", n => { Metadata = n.GetObjectValue<global::Marqeta.Core.Sdk.Models.Business_card_holder_update_metadata>(global::Marqeta.Core.Sdk.Models.Business_card_holder_update_metadata.CreateFromDiscriminatorValue); } },
                { "notes", n => { Notes = n.GetStringValue(); } },
                { "office_location", n => { OfficeLocation = n.GetObjectValue<global::Marqeta.Core.Sdk.Models.AddressRequestModel>(global::Marqeta.Core.Sdk.Models.AddressRequestModel.CreateFromDiscriminatorValue); } },
                ...
                { "proprietor_or_officer", n => { ProprietorOrOfficer = n.GetObjectValue<global::Marqeta.Core.Sdk.Models.Business_proprietor>(global::Marqeta.Core.Sdk.Models.Business_proprietor.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Marqeta.Core.Sdk.Models.Beneficial_owner_request>("beneficial_owner1", BeneficialOwner1);
            writer.WriteObjectValue<global::Marqeta.Core.Sdk.Models.Beneficial_owner_request>("beneficial_owner2", BeneficialOwner2);
            writer.WriteObjectValue<global::Marqeta.Core.Sdk.Models.Beneficial_owner_request>("beneficial_owner3", BeneficialOwner3);
            writer.WriteObjectValue<global::Marqeta.Core.Sdk.Models.Beneficial_owner_request>("beneficial_owner4", BeneficialOwner4);
            ...
            writer.WriteObjectValue<global::Marqeta.Core.Sdk.Models.Business_incorporation>("incorporation", Incorporation);
            ...
            writer.WriteObjectValue<global::Marqeta.Core.Sdk.Models.Business_card_holder_update_metadata>("metadata", Metadata);
            writer.WriteStringValue("notes", Notes);
            writer.WriteObjectValue<global::Marqeta.Core.Sdk.Models.AddressRequestModel>("office_location", OfficeLocation);
            ...
            writer.WriteObjectValue<global::Marqeta.Core.Sdk.Models.Business_proprietor>("proprietor_or_officer", ProprietorOrOfficer);
