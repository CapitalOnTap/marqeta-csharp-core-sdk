...
namespace Marqeta.Core.Sdk.Models {
    ...
    public class Velocity_control_update_request : IAdditionalDataHolder, IParsable 
...
#nullable restore
        ...
        public Velocity_control_update_request_velocity_window? VelocityWindow { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="Velocity_control_update_request"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Velocity_control_update_request"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Velocity_control_update_request CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Velocity_control_update_request();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"velocity_window", n => { VelocityWindow = n.GetEnumValue<Velocity_control_update_request_velocity_window>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Velocity_control_update_request_velocity_window>("velocity_window", VelocityWindow);
