...
namespace Marqeta.Core.Sdk.Models
{
    ...
    public partial class Velocity_control_update_request : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// <summary>If set to `true`, original credit transactions are subject to control.Your request can contain either a `money_in_transaction` object or the `include_credits` field, not both.</summary>
...
#nullable restore
        ...
        public string Name { get; set; }
#endif
        /// <summary>Unique identifier of the velocity control resource.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public global::Marqeta.Core.Sdk.Models.Velocity_control_update_request_velocity_window? VelocityWindow { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Models.Velocity_control_update_request"/> and sets the default values.
        /// </summary>
        public Velocity_control_update_request()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Models.Velocity_control_update_request"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Marqeta.Core.Sdk.Models.Velocity_control_update_request CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Marqeta.Core.Sdk.Models.Velocity_control_update_request();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "velocity_window", n => { VelocityWindow = n.GetEnumValue<global::Marqeta.Core.Sdk.Models.Velocity_control_update_request_velocity_window>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Marqeta.Core.Sdk.Models.Velocity_control_update_request_velocity_window>("velocity_window", VelocityWindow);
