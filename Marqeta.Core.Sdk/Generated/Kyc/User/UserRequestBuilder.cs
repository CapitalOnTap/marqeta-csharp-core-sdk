...
namespace Marqeta.Core.Sdk.Kyc.User
{
    ...
    public class UserRequestBuilder : BaseRequestBuilder
    {
        ...
        public Marqeta.Core.Sdk.Kyc.User.Item.WithUser_tokenItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("user_token", position);
                return new Marqeta.Core.Sdk.Kyc.User.Item.WithUser_tokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Kyc.User.UserRequestBuilder"/> and sets the default values.
        /// </summary>
