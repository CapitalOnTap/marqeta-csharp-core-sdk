...
#nullable enable
        public async Task<DigitalWalletTokenTransitionListResponse?> GetAsync(Action<RequestConfiguration<WithTokenItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<DigitalWalletTokenTransitionListResponse> GetAsync(Action<RequestConfiguration<WithTokenItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<DigitalWalletTokenTransitionListResponse>(requestInfo, DigitalWalletTokenTransitionListResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Use this endpoint to return an array of all transitions for a particular digital wallet token.This endpoint supports &lt;&lt;/core-api/field-filtering, field filtering&gt;&gt;, &lt;&lt;/core-api/sorting-and-pagination, pagination&gt;&gt;, and &lt;&lt;/core-api/sorting-and-pagination, sorting&gt;&gt;.
        /// </summary>
