...
namespace Marqeta.Core.Sdk.Digitalwallettokentransitions.Digitalwallettoken.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Digitalwallettokentransitions.Digitalwallettoken.Item.WithTokenItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Models.DigitalWalletTokenTransitionListResponse"/></returns>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.DigitalWalletTokenTransitionListResponse?> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Digitalwallettokentransitions.Digitalwallettoken.Item.WithTokenItemRequestBuilder.WithTokenItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.DigitalWalletTokenTransitionListResponse> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Digitalwallettokentransitions.Digitalwallettoken.Item.WithTokenItemRequestBuilder.WithTokenItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Marqeta.Core.Sdk.Models.DigitalWalletTokenTransitionListResponse>(requestInfo, global::Marqeta.Core.Sdk.Models.DigitalWalletTokenTransitionListResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Use this endpoint to return an array of all transitions for a particular digital wallet token.This endpoint supports &lt;&lt;/core-api/field-filtering, field filtering&gt;&gt;, &lt;&lt;/core-api/sorting-and-pagination, pagination&gt;&gt;, and &lt;&lt;/core-api/sorting-and-pagination, sorting&gt;&gt;.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Digitalwallettokentransitions.Digitalwallettoken.Item.WithTokenItemRequestBuilder.WithTokenItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Digitalwallettokentransitions.Digitalwallettoken.Item.WithTokenItemRequestBuilder.WithTokenItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Digitalwallettokentransitions.Digitalwallettoken.Item.WithTokenItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Digitalwallettokentransitions.Digitalwallettoken.Item.WithTokenItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Digitalwallettokentransitions.Digitalwallettoken.Item.WithTokenItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Use this endpoint to return an array of all transitions for a particular digital wallet token.This endpoint supports &lt;&lt;/core-api/field-filtering, field filtering&gt;&gt;, &lt;&lt;/core-api/sorting-and-pagination, pagination&gt;&gt;, and &lt;&lt;/core-api/sorting-and-pagination, sorting&gt;&gt;.
        /// </summary>
