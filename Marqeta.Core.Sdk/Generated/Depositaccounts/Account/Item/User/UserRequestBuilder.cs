...
namespace Marqeta.Core.Sdk.Depositaccounts.Account.Item.User
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Depositaccounts.Account.Item.User.UserRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Depositaccounts.Account.Item.User.UserRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Depositaccounts.Account.Item.User.UserRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Depositaccounts.Account.Item.User.UserRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
