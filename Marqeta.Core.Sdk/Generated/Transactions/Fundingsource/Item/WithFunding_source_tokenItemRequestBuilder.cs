...
namespace Marqeta.Core.Sdk.Transactions.Fundingsource.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Transactions.Fundingsource.Item.WithFunding_source_tokenItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.TransactionModelListResponse?> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Transactions.Fundingsource.Item.WithFunding_source_tokenItemRequestBuilder.WithFunding_source_tokenItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.TransactionModelListResponse> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Transactions.Fundingsource.Item.WithFunding_source_tokenItemRequestBuilder.WithFunding_source_tokenItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Transactions.Fundingsource.Item.WithFunding_source_tokenItemRequestBuilder.WithFunding_source_tokenItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Transactions.Fundingsource.Item.WithFunding_source_tokenItemRequestBuilder.WithFunding_source_tokenItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Transactions.Fundingsource.Item.WithFunding_source_tokenItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Transactions.Fundingsource.Item.WithFunding_source_tokenItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// List transactions for a specific funding source.By default, this endpoint returns transactions conducted within the last 30 days.To return transactions older than 30 days, you must include the `start_date` and `end_date` query parameters in your request.By default, `GET /transactions/fundingsource/{funding_source_token}` returns transactions having either `PENDING` or `COMPLETION` states.This endpoint supports &lt;&lt;/core-api/field-filtering, field filtering&gt;&gt; and &lt;&lt;/core-api/sorting-and-pagination, pagination&gt;&gt;.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithFunding_source_tokenItemRequestBuilderGetQueryParameters 
        {
...
#nullable restore
            ...
            public global::Marqeta.Core.Sdk.Transactions.Fundingsource.Item.GetPolarityQueryParameterType? Polarity { get; set; }
            ...
            public global::Marqeta.Core.Sdk.Transactions.Fundingsource.Item.GetSort_byQueryParameterType? SortBy { get; set; }
