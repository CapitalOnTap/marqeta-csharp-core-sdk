...
namespace Marqeta.Core.Sdk.Users.Item.Ssn
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Users.Item.Ssn.SsnRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.Ssn_response_model?> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Users.Item.Ssn.SsnRequestBuilder.SsnRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.Ssn_response_model> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Users.Item.Ssn.SsnRequestBuilder.SsnRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Users.Item.Ssn.SsnRequestBuilder.SsnRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Users.Item.Ssn.SsnRequestBuilder.SsnRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Users.Item.Ssn.SsnRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Users.Item.Ssn.SsnRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Users.Item.Ssn.SsnRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// To retrieve the government-issued identification number for a user, send a `GET` request to the `/users/{token}/ssn` endpoint.Include the `token` path parameter to specify the user whose identification number (SSN, TIN, NIN, SIN) you wish to return.You can indicate whether to return the full number or the last four digits only.
        /// </summary>
