...
using Marqeta.Core.Sdk.Users.Item.Notes.Item;
...
using System;
namespace Marqeta.Core.Sdk.Users.Item.Notes
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the Marqeta.Core.Sdk.users.item.notes.item collection</summary>
        ...
        public global::Marqeta.Core.Sdk.Users.Item.Notes.Item.WithNotes_tokenItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("notes_token", position);
                return new global::Marqeta.Core.Sdk.Users.Item.Notes.Item.WithNotes_tokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Users.Item.Notes.NotesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public NotesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{parent_token%2Did}/notes{?count*,created_by*,created_by_user_role*,fields*,include_private*,search_type*,sort_by*,start_index*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Users.Item.Notes.NotesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public NotesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{parent_token%2Did}/notes{?count*,created_by*,created_by_user_role*,fields*,include_private*,search_type*,sort_by*,start_index*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.CardHolderNoteListResponse?> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Users.Item.Notes.NotesRequestBuilder.NotesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.CardHolderNoteListResponse> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Users.Item.Notes.NotesRequestBuilder.NotesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Users.Item.Notes.NotesRequestBuilder.NotesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Users.Item.Notes.NotesRequestBuilder.NotesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Users.Item.Notes.NotesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Users.Item.Notes.NotesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Users.Item.Notes.NotesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists cardholder notes
        /// </summary>
