...
namespace Marqeta.Core.Sdk.Rewardprograms.Redemptions
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Marqeta.Core.Sdk.Models.RedemptionsBySettlementDatePage?> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder.RedemptionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Marqeta.Core.Sdk.Models.RedemptionsBySettlementDatePage> GetAsync(Action<RequestConfiguration<Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder.RedemptionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Marqeta.Core.Sdk.Models.RedemptionsBySettlementDatePage>(requestInfo, Marqeta.Core.Sdk.Models.RedemptionsBySettlementDatePage.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// retrieves all completed redemptions by settlement date
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder.RedemptionsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder.RedemptionsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder WithUrl(string rawUrl)
        {
            return new Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// retrieves all completed redemptions by settlement date
        /// </summary>
