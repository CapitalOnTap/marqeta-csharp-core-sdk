...
namespace Marqeta.Core.Sdk.Rewardprograms.Redemptions
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.RedemptionsBySettlementDatePage?> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder.RedemptionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.RedemptionsBySettlementDatePage> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder.RedemptionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Marqeta.Core.Sdk.Models.RedemptionsBySettlementDatePage>(requestInfo, global::Marqeta.Core.Sdk.Models.RedemptionsBySettlementDatePage.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// retrieves all completed redemptions by settlement date
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder.RedemptionsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder.RedemptionsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Rewardprograms.Redemptions.RedemptionsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// retrieves all completed redemptions by settlement date
        /// </summary>
