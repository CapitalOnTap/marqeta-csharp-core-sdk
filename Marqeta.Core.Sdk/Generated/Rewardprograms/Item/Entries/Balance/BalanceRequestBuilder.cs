...
namespace Marqeta.Core.Sdk.Rewardprograms.Item.Entries.Balance
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marqeta.Core.Sdk.Rewardprograms.Item.Entries.Balance.BalanceRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Marqeta.Core.Sdk.Models.RewardProgramsEntriesBalanceResponse?> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Rewardprograms.Item.Entries.Balance.BalanceRequestBuilder.BalanceRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marqeta.Core.Sdk.Models.RewardProgramsEntriesBalanceResponse> GetAsync(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Rewardprograms.Item.Entries.Balance.BalanceRequestBuilder.BalanceRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Marqeta.Core.Sdk.Models.RewardProgramsEntriesBalanceResponse>(requestInfo, global::Marqeta.Core.Sdk.Models.RewardProgramsEntriesBalanceResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieve the balance of reward entries, which is the accrued rewards amount, within a specified date range.The reward accrual service calculates values to four-decimal precision, however the `/credit/rewardprograms/{token}/entries/balance` endpoint returns pending and accrued balances to two-decimal precision.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Rewardprograms.Item.Entries.Balance.BalanceRequestBuilder.BalanceRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marqeta.Core.Sdk.Rewardprograms.Item.Entries.Balance.BalanceRequestBuilder.BalanceRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marqeta.Core.Sdk.Rewardprograms.Item.Entries.Balance.BalanceRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marqeta.Core.Sdk.Rewardprograms.Item.Entries.Balance.BalanceRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marqeta.Core.Sdk.Rewardprograms.Item.Entries.Balance.BalanceRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve the balance of reward entries, which is the accrued rewards amount, within a specified date range.The reward accrual service calculates values to four-decimal precision, however the `/credit/rewardprograms/{token}/entries/balance` endpoint returns pending and accrued balances to two-decimal precision.
        /// </summary>
