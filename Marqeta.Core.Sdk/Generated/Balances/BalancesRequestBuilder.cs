...
using Marqeta.Core.Sdk.Balances.Account;
using Marqeta.Core.Sdk.Balances.Item;
using Marqeta.Core.Sdk.Balances.User;
...
namespace Marqeta.Core.Sdk.Balances
{
    ...
    public partial class BalancesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Marqeta.Core.Sdk.Balances.Account.AccountRequestBuilder Account
        {
            get => new global::Marqeta.Core.Sdk.Balances.Account.AccountRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The user property</summary>
        public global::Marqeta.Core.Sdk.Balances.User.UserRequestBuilder User
        {
            get => new global::Marqeta.Core.Sdk.Balances.User.UserRequestBuilder(PathParameters, RequestAdapter);
        }
